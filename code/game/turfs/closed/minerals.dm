...
/turf/closed/mineral //wall piece
	name = "rock"
	icon = MAP_SWITCH('modular_babylon/master_files/icons/turf/smoothrocks.dmi', 'icons/turf/mining.dmi') // NOVA EDIT CHANGE - ORIGINAL: icon = MAP_SWITCH('icons/turf/smoothrocks.dmi', 'icons/turf/mining.dmi')
	icon_state = "rock"
