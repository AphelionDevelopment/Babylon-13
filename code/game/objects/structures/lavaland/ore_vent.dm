...
/obj/structure/ore_vent/proc/add_mineral_overlays()
	...
	if(artifact_chance)
		var/atom/movable/flick_visual/rare = flick_overlay_view(mutable_appearance('modular_babylon/master_files/icons/effects/vent_overlays.dmi', "artifact"), 4.5 SECONDS) // NOVA EDIT - Changed 'rare_ore' to 'artifact' for icon_state
