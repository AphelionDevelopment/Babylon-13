...
/atom/movable/screen/map_view/char_preview/proc/update_body()
	...
	if (isnull(canvas) || last_canvas_size != canvas_size || last_canvas_state != canvas_state)
		switch (canvas_size)
			if (0)
				canvas = image('modular_babylon/modules/character_preview_background/icons/background_32x32.dmi', icon_state = canvas_state)
			if (1)
				canvas = image('modular_babylon/modules/character_preview_background/icons/background_64x64.dmi', icon_state = canvas_state)
			if (2)
				canvas = image('modular_babylon/modules/character_preview_background/icons/background_96x96.dmi', icon_state = canvas_state)
