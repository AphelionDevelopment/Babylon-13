...
/datum/preference_middleware/quirks/get_constant_data()
	...
	for (var/quirk_name in quirks)
		...
		quirk_info[sanitize_css_class_name(quirk_name)] = list(
			...
			"babylon_stars_only" = initial(quirk.babylon_stars_only), // NOVA EDIT ADDITION - Veteran quirks
...
/datum/preference_middleware/quirks/proc/give_quirk(list/params, mob/user)
	...
	var/list/quirks = SSquirks.get_quirks()
	var/datum/quirk/quirk = quirks[quirk_name]
	if(GLOB.babylon_star_restrictions && initial(quirk.babylon_stars_only) && !SSplayer_ranks.is_babylon_star(preferences?.parent))
		return FALSE
	//NOVA EDIT END
...
/datum/preference_middleware/quirks/proc/get_selected_quirks()
	...
	for (var/quirk in preferences.all_quirks)
		...
		if(GLOB.babylon_star_restrictions && initial(quirk_datum.babylon_stars_only) && !SSplayer_ranks.is_babylon_star(preferences?.parent))
