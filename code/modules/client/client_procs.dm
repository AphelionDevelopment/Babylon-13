...
/client/New(TopicData)
	...
	// BABYLON EDIT ADDITION - second pass of an imported savefile. Has to be after migration so every value can go back through the validating write path.
...
/client/proc/add_verbs_from_config()
	...
	// BABYLON EDIT ADDITION - whitelisted-player preferences import. This only offers the verb, it re-checks the whitelist when run.
