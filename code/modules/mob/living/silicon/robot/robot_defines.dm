...
/mob/living/silicon/robot
	name = "Cyborg"
	real_name = "Cyborg"
	icon = 'icons/mob/silicon/robots.dmi' //NOVA EDIT - Modified in modular_babylon\modules\altborgs\code\robot_defines.dm (to allow for custom transformation animations)
	icon_state = "robot"
	maxHealth = 100
	health = 100
	bubble_icon = "robot"
