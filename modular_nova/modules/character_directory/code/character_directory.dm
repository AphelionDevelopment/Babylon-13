...
/datum/character_directory/ui_static_data(mob/user)
	...
	for(var/mob/mob in GLOB.alive_player_list)
		...
		babylon_star_status = mob.client && SSplayer_ranks.is_babylon_star(mob.client, admin_bypass = FALSE)
		...
		directory_mobs.Add(list(list(
			...
			"noncon" = noncon,
			"hypno" = hypno,
			"babylon_star_status" = babylon_star_status,
