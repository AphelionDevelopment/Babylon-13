...
/obj/item/card/id/advanced/visitor
	name = "visitor's ID"
	icon_state = "visitor"
	icon = 'modular_babylon/master_files/code/datums/quirks/negative_quirks/visitor/icons/card.dmi'
...
/datum/id_trim/job/assistant/visitor
	...
	trim_icon = 'modular_babylon/master_files/code/datums/quirks/negative_quirks/visitor/icons/card.dmi'
