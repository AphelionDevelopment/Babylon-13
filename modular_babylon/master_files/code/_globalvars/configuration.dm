...
GLOBAL_VAR(babylon_star_restrictions)
...
/// Are the TG gas prices being overridden? See modular_babylon\modules\customization\__HELPERS\global_lists.dm to configure the prices.
