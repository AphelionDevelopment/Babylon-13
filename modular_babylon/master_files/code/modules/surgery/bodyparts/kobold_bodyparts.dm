/obj/item/bodypart/head/kobold
	icon = 'modular_babylon/master_files/icons/mob/species/kobold_bodyparts.dmi'
	icon_greyscale = 'modular_babylon/master_files/icons/mob/species/kobold_bodyparts.dmi'
