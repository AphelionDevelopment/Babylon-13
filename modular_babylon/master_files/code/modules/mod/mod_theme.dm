...
// modular_babylon/master_files/icons/mob/clothing/modsuit/mod_clothing_mutant.dmi
/datum/mod_theme/syndicate/deepspace
	...
	variants = list(
		"deepspace" = list(
			MOD_ICON_OVERRIDE = 'modular_babylon/master_files/icons/obj/clothing/modsuit/mod_clothing.dmi',
			MOD_WORN_ICON_OVERRIDE = 'modular_babylon/master_files/icons/mob/clothing/modsuit/mod_clothing.dmi',
...
/datum/mod_theme/marines
	...
	variants = list(
		"marine" = list(
			MOD_ICON_OVERRIDE = 'modular_babylon/master_files/icons/obj/clothing/modsuit/mod_clothing.dmi',
			MOD_WORN_ICON_OVERRIDE = 'modular_babylon/master_files/icons/mob/clothing/modsuit/mod_clothing.dmi',
			MOD_DIGITIGRADE_ICON_OVERRIDE = 'modular_babylon/master_files/icons/mob/clothing/modsuit/mod_clothing_mutant.dmi',
			MOD_SNOUT_ICON_OVERRIDE = 'modular_babylon/master_files/icons/mob/clothing/modsuit/mod_clothing_mutant.dmi',
			/obj/item/clothing/head/mod = list(
				UNSEALED_LAYER = NECK_LAYER,
				UNSEALED_CLOTHING = SNUG_FIT,
