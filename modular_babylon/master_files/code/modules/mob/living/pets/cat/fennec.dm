/mob/living/basic/pet/cat/fennec
	...
	icon = 'modular_babylon/master_files/icons/mob/pets.dmi'
	icon_state = "fennec"
	icon_living = "fennec"
	icon_dead = "fennec_dead"
	held_lh = 'modular_babylon/master_files/icons/mob/inhands/pets_held_lh.dmi'
	held_rh = 'modular_babylon/master_files/icons/mob/inhands/pets_held_rh.dmi'
	head_icon = 'modular_babylon/master_files/icons/mob/clothing/head/pets_head.dmi'
...
/datum/ai_controller/basic_controller/cat/fennec
	behavior_tree_json = "modular_babylon/master_files/code/modules/mob/living/pets/cat/fennec.bt.json"
