/obj/docking_port/mobile
	...
	var/takeoff_sound = sound('modular_babylon/modules/advanced_shuttles/sound/engine_startup.ogg')
	/// The landing sound to be played
	var/landing_sound = sound('modular_babylon/modules/advanced_shuttles/sound/engine_landing.ogg')
