...
/datum/quirk/equipping/entombed/add_unique(client/client_source)
	...
	switch(LOWER_TEXT(modsuit.skin))
		if ("colonist", "tarkon", "voskhod")
			modsuit.icon = 'modular_babylon/master_files/icons/obj/clothing/modsuit/mod_clothing.dmi'
			modsuit.worn_icon = 'modular_babylon/master_files/icons/mob/clothing/modsuit/mod_clothing.dmi'
	...
	for(var/obj/item/part as anything in modsuit.get_parts())
		...
		switch(LOWER_TEXT(modsuit.skin))
			if ("colonist", "tarkon", "voskhod")
				part.icon = 'modular_babylon/master_files/icons/obj/clothing/modsuit/mod_clothing.dmi'
				part.worn_icon = 'modular_babylon/master_files/icons/mob/clothing/modsuit/mod_clothing.dmi'
