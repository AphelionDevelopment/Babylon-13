...
#define TOWEL_OBJ_ICON 'modular_babylon/master_files/icons/obj/clothing/towel.dmi'
/// Icon path to the worn icon of the towel.
#define TOWEL_WORN_ICON 'modular_babylon/master_files/icons/mob/clothing/towel.dmi'
/// Icon path to the worn icon of the towel for digitigrades.
#define TOWEL_WORN_ICON_DIGI 'modular_babylon/master_files/icons/mob/clothing/towel_digi.dmi'
/// Icon path to the left-hand inhand icons of the towel.
#define TOWEL_LEFTHAND_ICON 'modular_babylon/master_files/icons/mob/inhands/clothing/towel_lefthand.dmi'
/// Icon path to the right-hand inhand icons of the towel.
#define TOWEL_RIGHTHAND_ICON 'modular_babylon/master_files/icons/mob/inhands/clothing/towel_righthand.dmi'
