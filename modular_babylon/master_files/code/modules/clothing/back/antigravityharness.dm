...
/obj/item/gravity_harness
	...
	worn_icon_teshari = 'modular_babylon/master_files/icons/mob/clothing/species/teshari/back.dmi'
...
/obj/item/gravity_harness/proc/change_mode(target_mode)
	...
	switch(target_mode)
		...
		if(MODE_EXTRAGRAVITY)
			...
			playsound(src, 'modular_babylon/master_files/sound/effects/robot_sit.ogg', 25)
