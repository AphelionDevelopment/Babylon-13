/obj/item/clothing/head/hats/caphat/azulean
	...
	icon = 'modular_babylon/master_files/icons/obj/clothing/head/akula_official.dmi'
	worn_icon = 'modular_babylon/master_files/icons/mob/clothing/head/akula_official.dmi'
