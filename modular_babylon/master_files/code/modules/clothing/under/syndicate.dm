...
/obj/item/clothing/under/syndicate
	worn_icon_digi = 'modular_babylon/master_files/icons/mob/clothing/under/syndicate_digi.dmi'

/obj/item/clothing/under/syndicate/nova
	icon = 'modular_babylon/master_files/icons/obj/clothing/under/syndicate.dmi'
	worn_icon = 'modular_babylon/master_files/icons/mob/clothing/under/syndicate.dmi'
...
//Related files:
// modular_babylon\modules\syndie_edits\code\syndie_edits.dm (this has the Overalls and non-Uniforms)
// modular_babylon\modules\novaya_ert\code\uniform.dm (HC uniform(s))
...
/obj/item/clothing/under/syndicate/tacticool //Overwrites the 'fake' one. Zero armor, sensors, and default blue. More Balanced to make station-available.
	...
	icon = 'modular_babylon/master_files/icons/obj/clothing/under/syndicate.dmi' //Since its an overwrite it needs new icon linking. Woe.
	worn_icon = 'modular_babylon/master_files/icons/mob/clothing/under/syndicate.dmi'
