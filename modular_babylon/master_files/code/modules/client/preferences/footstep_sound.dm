...
/datum/preference/choiced/footstep_sound/apply_to_human(mob/living/carbon/human/target, value)
	...
	var/static/list/value_to_define = list(
		...
		"Highheels" = list(list(
			'modular_babylon/master_files/sound/effects/footstep/highheel1.ogg',
			'modular_babylon/master_files/sound/effects/footstep/highheel2.ogg',
			'modular_babylon/master_files/sound/effects/footstep/highheel3.ogg',
			'modular_babylon/master_files/sound/effects/footstep/highheel4.ogg'), 70, 1),
		"Hooves" = list(list(
			'modular_babylon/master_files/sound/effects/footstep/hardhoof1.ogg',
			'modular_babylon/master_files/sound/effects/footstep/hardhoof2.ogg',
			'modular_babylon/master_files/sound/effects/footstep/hardhoof3.ogg',
			'modular_babylon/master_files/sound/effects/footstep/hardhoof4.ogg'), 35, 1),
	)
