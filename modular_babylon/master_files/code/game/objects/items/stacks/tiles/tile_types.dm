/obj/item/stack/tile/carpet/kinaris
	...
	icon_state = "kinaris"
	icon = 'modular_babylon/master_files/icons/obj/tiles.dmi'

	inhand_icon_state = "kinaris"
	lefthand_file = 'modular_babylon/master_files/icons/mob/inhands/tiles_lefthand.dmi'
	righthand_file = 'modular_babylon/master_files/icons/mob/inhands/tiles_righthand.dmi'
