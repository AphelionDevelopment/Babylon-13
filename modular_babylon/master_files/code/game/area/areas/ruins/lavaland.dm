...
/area/ruin/interdyne_planetary_base/cargo/obs/Initialize(mapload)
	if(!ambientsounds)
		...
		ambientsounds += list(
			'modular_babylon/modules/random_ship_event/random_ships/heliostatic_inspectors/sounds/morse.ogg',
...
/area/ruin/interdyne_planetary_base/eng
	...
	ambient_buzz = 'modular_babylon/modules/random_ship_event/random_ships/heliostatic_inspectors/sounds/gear_loop.ogg'
