...
/obj/item/knife/bowie
	...
	icon = 'modular_babylon/modules/knives/icons/bowie.dmi'
	icon_state = "bowiehand"
	inhand_icon_state = "bowiehand"
	lefthand_file = 'modular_babylon/modules/knives/icons/bowie_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/knives/icons/bowie_righthand.dmi'
...
/obj/item/storage/belt/bowie_sheath
	...
	icon = 'modular_babylon/modules/knives/icons/bowiepocket.dmi'
