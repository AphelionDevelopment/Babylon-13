...
/obj/structure/statue/hearthkin/frozenwake/stele
	...
	icon = 'modular_babylon/modules/primitive_catgirls/icons/gods_statue.dmi' // needs its own sprite
...
/obj/structure/statue/hearthkin/frozenwake/stele/proc/add_runic_glow()
	return emissive_appearance(
		'modular_babylon/modules/primitive_catgirls/icons/gods_statue.dmi',
		"[icon_state]-emissive",
		src,
		alpha = src.alpha
	)
