...
/turf/closed/wall/mineral/titanium/spaceship
	icon = 'modular_babylon/modules/mapping/icons/unique/spaceships/shipwalls.dmi'
...
/turf/closed/wall/mineral/titanium/spaceship/nodiagonal
	icon = MAP_SWITCH('modular_babylon/modules/mapping/icons/unique/spaceships/shipwalls.dmi', 'modular_babylon/modules/mapping/icons/unique/spaceships/ship_misc.dmi')
...
/obj/structure/window/reinforced/shuttle/spaceship
	...
	icon = 'modular_babylon/modules/mapping/icons/unique/spaceships/shipwindows.dmi'
