...
/obj/item/gps/computer/space //Subtype that runs pod computer code, with a texture to blend better with normal walls
	icon = 'modular_babylon/modules/mapping/icons/machinery/gps_computer.dmi'	//needs its own file for pixel size ;-;
	name = "gps computer"
...
/obj/machinery/power/micro_reactor
	icon = 'modular_babylon/modules/mapping/icons/machinery/reactor.dmi'
	name = "micro reactor"
