...
/datum/map_template/ruin/icemoon/underground/nova/interdyne_base
	name = "Ice-ruin Interdyne Pharmaceuticals Babylon Base 8817238"
	id = "ice-base"
...
/obj/structure/statue/hearthkin/odin
	...
	icon = 'modular_babylon/modules/primitive_catgirls/icons/gods_statue.dmi'
...
//declaration for the Frozenwake ruin, the rest can be found in modular_babylon\modules\mapping\code\frozenwake.dm
