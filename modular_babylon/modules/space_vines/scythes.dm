/obj/item/scythe
	...
	icon = 'modular_babylon/modules/space_vines/icons/items_and_weapons.dmi'
	icon_state = "scythe_t1"
	worn_icon = 'modular_babylon/modules/space_vines/icons/back.dmi'
	lefthand_file = 'modular_babylon/modules/space_vines/icons/polearms_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/space_vines/icons/polearms_righthand.dmi'
	force = 13
	throwforce = 5
	throw_speed = 2
	throw_range = 3
