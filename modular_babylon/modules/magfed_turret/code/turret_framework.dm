...
/obj/item/target_designator
	...
	icon = 'modular_babylon/modules/magfed_turret/icons/designator.dmi'
	icon_state = "designator"
	inhand_icon_state = "designator"
	righthand_file = 'modular_babylon/modules/magfed_turret/icons/inhands/righthand.dmi'
	lefthand_file = 'modular_babylon/modules/magfed_turret/icons/inhands/righthand.dmi'
	worn_icon_state = "designator"
	worn_icon = 'modular_babylon/modules/magfed_turret/icons/mob/belt.dmi'
...
/obj/machinery/porta_turret/syndicate/toolbox/mag_fed/proc/play_fire_sound(obj/item/ammo_casing/soundmaker) //Hella Iffy.
	...
	if(!adjustable_magwell) //if it has 1 magazine type
		...
		fire_sound = 'modular_babylon/modules/modular_weapons/sounds/pistol_light.ogg'
		...
		fire_sound = 'modular_babylon/modules/modular_weapons/sounds/smg_light.ogg'
