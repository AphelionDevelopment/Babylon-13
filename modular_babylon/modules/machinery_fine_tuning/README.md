...
- `modular_babylon/modules/mapping/code/areas/shuttles.dm`
  DS2, Tarkon areas
- `modular_babylon/modules/mapping/code/areas/space.dm`
  Interdyne areas
- `modular_babylon/master_files/code/game/area/areas/ruins/lavaland.dm`
