...
/obj/item/melee/implantarmblade
	...
	icon = 'modular_babylon/modules/implants/icons/implanted_blade.dmi'
	righthand_file = 'modular_babylon/modules/implants/icons/implanted_blade_righthand.dmi'
	lefthand_file = 'modular_babylon/modules/implants/icons/implanted_blade_lefthand.dmi'
	...
	hitsound = 'modular_babylon/master_files/sound/weapons/bloodyslice.ogg'
...
/obj/item/knife/razor_claws
	...
	icon = 'modular_babylon/modules/implants/icons/razorclaws.dmi'
	righthand_file = 'modular_babylon/modules/implants/icons/razorclaws_righthand.dmi'
	lefthand_file = 'modular_babylon/modules/implants/icons/razorclaws_lefthand.dmi'
...
/datum/action/item_action/organ_action/toggle/razor_claws
	...
	button_icon = 'modular_babylon/master_files/icons/hud/actions.dmi'
...
/obj/item/organ/cyberimp/arm/toolkit/mining_drill
	...
	icon = 'modular_babylon/modules/implants/icons/drillimplant.dmi'
	icon_state = "steel"
	items_to_create = list(/obj/item/pickaxe/drill/implant)
	aug_icon = 'modular_babylon/modules/implants/icons/implants_onmob.dmi'
	aug_overlay = "steel"
	hand_state = FALSE
	custom_materials = list(/datum/material/iron = SHEET_MATERIAL_AMOUNT, /datum/material/glass = HALF_SHEET_MATERIAL_AMOUNT, /datum/material/silver = HALF_SHEET_MATERIAL_AMOUNT)
...
/obj/item/pickaxe/drill/implant
	...
	slot_flags = NONE
	icon = 'modular_babylon/modules/implants/icons/drillimplant.dmi'
	righthand_file = 'modular_babylon/modules/implants/icons/drillimplant_righthand.dmi'
	lefthand_file = 'modular_babylon/modules/implants/icons/drillimplant_lefthand.dmi'
	icon_state = "steel"
...
/obj/item/pickaxe/drill/implant/verb/spin()
	...
	playsound(user, 'modular_babylon/master_files/sound/effects/robot_smoke.ogg', 50, FALSE)
...
/obj/item/melee/razorwire
	...
	icon = 'modular_babylon/modules/implants/icons/implants.dmi'
	icon_state = "razorwire_weapon"
	righthand_file = 'modular_babylon/modules/implants/icons/inhands/righthand.dmi'
	lefthand_file = 'modular_babylon/modules/implants/icons/inhands/lefthand.dmi'
...
/obj/item/gun/ballistic/shotgun/shell_launcher
	...
	obj_flags = UNIQUE_RENAME
	rack_sound = 'modular_babylon/modules/modular_weapons/sounds/shotgun_rack.ogg'
	semi_auto = TRUE
