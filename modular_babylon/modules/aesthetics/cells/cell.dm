/obj/item/stock_parts/power_store/cell
	icon = 'modular_babylon/modules/aesthetics/cells/icons/cell.dmi'
...
/obj/item/stock_parts/power_store/cell/update_overlays()
	...
	var/icon_link
	if(!grown_battery)
		icon_link = 'modular_babylon/modules/aesthetics/cells/icons/cell.dmi'
	else
...
/obj/machinery/cell_charger/update_overlays()
	...
	if(!charging.charging_icon)
		...
		.+= image('modular_babylon/modules/aesthetics/cells/icons/cell.dmi', charging.charging_icon)\
