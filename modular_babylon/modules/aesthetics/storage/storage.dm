...
/obj/item/storage/box
	icon = 'modular_babylon/modules/aesthetics/storage/icons/storage.dmi'
...
/obj/item/storage/box/papersack
	...
	var/modular_additions_icon = 'modular_babylon/master_files/icons/obj/storage/paperbag.dmi'
