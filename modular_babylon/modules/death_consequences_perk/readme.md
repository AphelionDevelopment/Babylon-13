...
E.g:
- `modular_babylon/master_files/sound/my_cool_sound.ogg`
- `modular_babylon/master_files/code/my_modular_override.dm`: `proc/overriden_proc`, `var/overriden_var`
  -->
...
- modular_babylon\master_files\code\modules\client\preferences\quirks\death_consequences.dm
