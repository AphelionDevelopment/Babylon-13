...
/mob/living/basic/mold
	...
	icon = 'modular_babylon/modules/mold/icons/blob_mobs.dmi'
...
/datum/ai_controller/basic_controller/oil_shambler
	behavior_tree_json = "modular_babylon/modules/mold/code/oil_shambler.bt.json"
	blackboard = list(
...
/datum/ai_controller/basic_controller/diseased_rat
	behavior_tree_json = "modular_babylon/modules/mold/code/diseased_rat.bt.json"
	blackboard = list(
		BB_TARGETING_STRATEGY = /datum/targeting_strategy/basic,
	)
...
/datum/ai_controller/basic_controller/electric_mosquito
	behavior_tree_json = "modular_babylon/modules/mold/code/electric_mosquito.bt.json"
	blackboard = list(
		BB_TARGETING_STRATEGY = /datum/targeting_strategy/basic,
	)
...
/mob/living/basic/mold/centaur/melee_attack(atom/target, list/modifiers, ignore_cooldown)
	...
	if(prob(irradiate_chance))
		...
		playsound(src, 'modular_babylon/modules/horrorform/sound/horror_scream.ogg', CENTAUR_ATTACK_SCREAM_VOLUME, TRUE)

/datum/ai_controller/basic_controller/centaur
	behavior_tree_json = "modular_babylon/modules/mold/code/centaur.bt.json"
	blackboard = list(
		BB_TARGETING_STRATEGY = /datum/targeting_strategy/basic,
	)
