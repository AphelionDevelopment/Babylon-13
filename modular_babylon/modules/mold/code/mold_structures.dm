...
/datum/looping_sound/core_heartbeat
	...
	mid_sounds = list('modular_babylon/master_files/sound/effects/heart_beat_loop3.ogg' = 1)
	volume = 20
...
/obj/structure/mold/structure/core
	name = "core"
	icon = 'modular_babylon/modules/mold/icons/blob_core.dmi'
...
/obj/structure/mold/resin
	...
	icon = 'modular_babylon/modules/mold/icons/blob_resin.dmi'
...
/obj/structure/mold/structure/bulb
	name = "bulb"
	icon = 'modular_babylon/modules/mold/icons/blob_bulb.dmi'
...
/obj/structure/mold/structure/conditioner
	...
	density = FALSE
	icon = 'modular_babylon/modules/mold/icons/blob_spawner.dmi'
