...
/obj/item/melee/macahuitl
	...
	lefthand_file = 'modular_babylon/modules/ashwalkers/icons/ashwalker_clothing_left.dmi'
	righthand_file = 'modular_babylon/modules/ashwalkers/icons/ashwalker_clothing_right.dmi'
