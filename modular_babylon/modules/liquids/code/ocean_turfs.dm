...
/turf/open/misc/ocean/rock
	...
	icon = 'modular_babylon/modules/liquids/icons/turf/seafloor.dmi'
	icon_state = "seafloor"
...
/turf/open/misc/ocean/rock/warm/fissure
	...
	icon = 'modular_babylon/modules/liquids/icons/turf/fissure.dmi'
...
/turf/open/floor/iron/submarine
	...
	icon = 'modular_babylon/modules/liquids/icons/turf/submarine.dmi'
