...
/obj/item/kinetic_crusher/machete
	icon = 'modular_babylon/modules/mining_crushers/icons/items_and_weapons.dmi'
	icon_state = "PKMachete"
	inhand_icon_state = "PKMachete0"
	lefthand_file = 'modular_babylon/modules/mining_crushers/icons/melee_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/mining_crushers/icons/melee_righthand.dmi'
	worn_icon = 'modular_babylon/modules/mining_crushers/icons/belt.dmi'
...
/obj/item/kinetic_crusher/spear
	...
	lefthand_file = 'modular_babylon/modules/mining_crushers/icons/melee_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/mining_crushers/icons/melee_righthand.dmi'
	worn_icon = 'modular_babylon/modules/mining_crushers/icons/back.dmi'
