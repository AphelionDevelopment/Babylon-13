...
/datum/antagonist/traitor/marauder
	...
	show_to_ghosts = TRUE
	give_uplink = FALSE
	stinger_sound = 'modular_babylon/modules/moretraitoritems/sound/wakeup.ogg'
...
/datum/antagonist/traitor/marauder/render_preview_outfit(datum/outfit/outfit, mob/living/carbon/human/dummy)
	...
	cool_robot_arm.set_icon_static('modular_babylon/master_files/icons/mob/augmentation/sgmipc.dmi')
