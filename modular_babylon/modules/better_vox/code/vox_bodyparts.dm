...
/obj/item/bodypart/head/mutant/vox_primalis
	icon_static = 'modular_babylon/modules/better_vox/icons/bodyparts/vox_bodyparts.dmi'
	icon_greyscale = 'modular_babylon/modules/better_vox/icons/bodyparts/vox_bodyparts.dmi'
	icon = 'modular_babylon/modules/better_vox/icons/bodyparts/vox_bodyparts.dmi'
	icon_state = "vox_primalis_head"
	bodyshape = parent_type::bodyshape | BODYSHAPE_CUSTOM
	is_dimorphic = FALSE
	should_draw_greyscale = FALSE
	limb_id = SPECIES_VOX_PRIMALIS
	eyes_icon = 'modular_babylon/modules/better_vox/icons/bodyparts/vox_eyes.dmi'
	teeth_count = 72
