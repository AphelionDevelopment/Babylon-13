...
/datum/reagent/drug/thc/overdose_process(mob/living/affected_mob, seconds_per_tick, metabolization_ratio)
	...
	if(SPT_PROB(3.5, seconds_per_tick))
		playsound(affected_mob, pick('modular_babylon/master_files/sound/effects/lungbust_cough1.ogg','modular_babylon/master_files/sound/effects/lungbust_cough2.ogg'), 50, TRUE)
