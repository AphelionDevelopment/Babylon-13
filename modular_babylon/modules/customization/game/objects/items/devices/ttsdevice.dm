...
/obj/item/ttsdevice/attack_self(mob/user)
	...
	playsound(src, 'modular_babylon/master_files/sound/items/tts/started_type.ogg', 50, TRUE)
	...
	if(!str)
		...
		playsound(src, 'modular_babylon/master_files/sound/items/tts/stopped_type.ogg', 50, TRUE)
		return
