...
/obj/item/toy/plush/nova
	icon = 'modular_babylon/master_files/icons/obj/plushes.dmi'
...
/obj/item/toy/plush/nova/ian
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/bark2.ogg' = 1)
	young = TRUE //No.
...
/obj/item/toy/plush/nova/towa
	...
	attack_verb_continuous = list("cuddles", "meows", "hisses")
	attack_verb_simple = list("cuddle", "meow", "hiss")
	squeak_override = list('modular_babylon/modules/kahraman_equipment/sound/thumper_thump/punch_press_2.wav' = 1)
...
/obj/item/toy/plush/nova/fushi
	...
	squeak_override = list(
		'modular_babylon/modules/emotes/sound/voice/wurble.ogg' = 10, //10% chance to wurble
		'modular_babylon/modules/emotes/sound/voice/weh.ogg' = 90,
	)
	gender = MALE
...
/obj/item/toy/plush/nova/robotics_shark
	...
	lefthand_file = 'modular_babylon/master_files/icons/mob/inhands/plushes_lefthand.dmi'
	righthand_file = 'modular_babylon/master_files/icons/mob/inhands/plushes_righthand.dmi'
