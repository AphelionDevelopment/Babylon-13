...
/obj/item/toy/plush/nova/donator/plushie_star
	...
	gender = FEMALE
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/trills.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/plushie_jeanne
	...
	squeak_override = list('modular_babylon/modules/customization/game/objects/items/sound/deerplush.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/plushie_elofy
	...
	squeak_override = list('modular_babylon/modules/customization/game/objects/items/sound/merowr.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/snow_owl
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/hoot.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/derg_plushie
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/weh.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/tracy
	...
	squeak_override = list('modular_babylon/modules/customization/game/objects/items/sound/tracymrowr.ogg' = 1)
	gender = FEMALE
...
/obj/item/toy/plush/nova/donator/plushie_synthia
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/emotes/twobeep.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/jecca
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/emotes/female/female_sigh.ogg' = 1)
	gender = FEMALE
...
/obj/item/toy/plush/nova/donator/plush_hemlock
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/arf.ogg'= 1)
...
/obj/item/toy/plush/nova/donator/plush_celica
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/slime_bubble.ogg' = 1)
	gender = FEMALE
...
/obj/item/toy/plush/nova/donator/plush_lasti
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/fox_squeak.ogg' = 1)
	gender = MALE
...
/obj/item/toy/plush/nova/donator/blue_cat
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/nya.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/leaplush
	...
	squeak_override = list('modular_babylon/modules/customization/game/objects/items/sound/leaplush.ogg' = 1)
	gender = FEMALE
...
/obj/item/toy/plush/nova/donator/sharknet
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/slime_squish.ogg' = 1)
	young = TRUE //No.
...
/obj/item/toy/plush/nova/donator/szaplush
	...
	squeak_override = list('modular_babylon/modules/customization/game/objects/items/sound/spiderplush.ogg' = 1)
	young = TRUE //No.
...
/obj/item/toy/plush/nova/donator/tribal_salamander
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/wurble.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/commanding_teshari
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/peep_once.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/skreking_vox
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/emotes/voxrustle.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/edgy_bird
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/caw.ogg' = 1)
...
/obj/item/toy/plush/nova/donator/xixi
	...
	attack_verb_simple = list(
		...
		"peck",)
	squeak_override = list(
		'modular_babylon/modules/emotes/sound/voice/peep_once.ogg' = 1,
		'modular_babylon/modules/emotes/sound/voice/caw.ogg' = 1,
		'modular_babylon/modules/emotes/sound/voice/bawk.ogg' = 1,
		'modular_babylon/modules/emotes/sound/emotes/voxscream.ogg' = 1,
		)
...
/obj/item/toy/plush/nova/donator/roselia
	...
	attack_verb_continuous = list("hugs")
	attack_verb_simple = list("hug")
	squeak_override = list('modular_babylon/modules/emotes/sound/voice/merp.ogg' = 1)
	young = FALSE
...
/obj/item/toy/plush/nova/donator/delphic_synth
	...
	squeak_override = list('modular_babylon/modules/emotes/sound/emotes/dwoop.ogg' = 1)
	attack_verb_continuous = list(
		"lobotomizes",
		"appendectomys",
		"transplants",
...
/obj/item/toy/plush/nova/donator/chunko/bonnie
	...
	squeak_override = list(
		...
		'modular_babylon/modules/emotes/sound/voice/mothsqueak.ogg' = 1,
		)
	responses = list(
...
/obj/item/toy/plush/nova/donator/bon
	...
	gender = FEMALE
	squeak_override = list(
		'modular_babylon/modules/emotes/sound/voice/slime_pop.ogg' = 1,
	)
