...
/obj/item/toy/plush/nova/melon
	...
	icon = 'modular_babylon/master_files/icons/obj/staff_plushies.dmi'
...
/obj/item/toy/plush/nova/parsec
	...
	squeak_override = list(
		'modular_babylon/modules/emotes/sound/voice/bork.ogg' = 2,
		'modular_babylon/modules/emotes/sound/voice/mrrp.ogg' = 1,
		'modular_babylon/modules/emotes/sound/voice/bark1.ogg' = 3,
		'modular_babylon/modules/emotes/sound/voice/growl.ogg' = 1,
		'modular_babylon/modules/emotes/sound/voice/awoo.ogg' = 1,
		'modular_babylon/modules/emotes/sound/emotes/blush.ogg' = 1,
...
/obj/item/toy/plush/nova/akinshi
	...
	squeak_override = list(
		'modular_babylon/modules/emotes/sound/voice/nya.ogg' = 1,
		'modular_babylon/modules/emotes/sound/voice/mggaow.ogg' = 1,
		'modular_babylon/modules/emotes/sound/voice/scream_cat.ogg' = 1,
		)
	var/responses = list(
		"Uh huh.",
		"Go back to training.",
