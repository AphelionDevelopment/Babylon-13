// Modular Booze REAGENTS, see the following file for the mixes: modular_babylon\modules\customization\modules\food_and_drinks\recipes\drinks_recipes.dm
...
/datum/glass_style/drinking_glass/synthanol
	...
	icon = 'modular_babylon/master_files/icons/obj/drinks.dmi' // This should cover anything synthanol related. Will have to individually tag others unless we make an object path for Nova drinks.
...
/datum/glass_style/drinking_glass/gunfire
	...
	icon = 'modular_babylon/master_files/icons/obj/drinks.dmi'
	icon_state = "gunfire"
