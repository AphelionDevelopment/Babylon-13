/datum/sprite_accessory/head_accessory
	icon = 'modular_babylon/master_files/icons/mob/sprite_accessory/head_accessory.dmi'
...
/datum/sprite_accessory/head_accessory/moogle_pom
	icon = 'modular_babylon/master_files/icons/mob/sprite_accessory/moogle_pom.dmi'
	recommended_species = list(
		SPECIES_MAMMAL = 1,
		SPECIES_HUMAN = 1,
	)
...
/datum/sprite_accessory/head_accessory/halo
	icon = 'modular_babylon/master_files/icons/mob/sprite_accessory/halo.dmi'
