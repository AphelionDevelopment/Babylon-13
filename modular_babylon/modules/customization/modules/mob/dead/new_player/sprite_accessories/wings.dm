...
* You can find a color palette to work with in modular_babylon\modules\customization\icons\mob\sprite_accessory\wings.dmi as 'colorpalette matrixcolors'
...
/datum/sprite_accessory/wings/mammal
	icon = 'modular_babylon/master_files/icons/mob/sprite_accessory/wings.dmi'
