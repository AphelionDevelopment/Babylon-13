...
/datum/sprite_accessory/screen
	icon = 'modular_babylon/master_files/icons/mob/sprite_accessory/ipc_screens.dmi'
	color_src = null
...
/datum/sprite_accessory/antenna
	icon = 'modular_babylon/master_files/icons/mob/sprite_accessory/ipc_antennas.dmi'
