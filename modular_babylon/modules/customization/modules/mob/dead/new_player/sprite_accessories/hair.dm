...
/datum/sprite_accessory/hair/nova
	icon = 'modular_babylon/master_files/icons/mob/sprite_accessory/hair.dmi'
...
/datum/sprite_accessory/hair/nova/halfshavedlong
	name = "Half-shaved long"
	icon = 'modular_babylon/master_files/icons/mob/sprite_accessory/more_hair.dmi'
...
/datum/sprite_accessory/facial_hair/nova
	icon = 'modular_babylon/master_files/icons/mob/sprite_accessory/facialhair.dmi'
