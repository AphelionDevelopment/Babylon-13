/datum/body_marking/moth
	icon = 'modular_babylon/master_files/icons/mob/body_markings/moth_markings.dmi'
...
/datum/body_marking/moth/grayscale
	icon = 'modular_babylon/master_files/icons/mob/body_markings/moth_grayscale_markings.dmi'
