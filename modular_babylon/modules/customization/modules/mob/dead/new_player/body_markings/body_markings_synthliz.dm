/datum/body_marking/secondary/synthliz
	icon = 'modular_babylon/master_files/icons/mob/body_markings/synthliz_secondary.dmi'
...
/datum/body_marking/tertiary/synthliz
	icon = 'modular_babylon/master_files/icons/mob/body_markings/synthliz_tertiary.dmi'
	recommended_species = null
