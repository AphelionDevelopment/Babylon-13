...
/datum/body_marking/other
	icon = 'modular_babylon/master_files/icons/mob/body_markings/other_markings.dmi'
...
/datum/body_marking/secondary
	icon = 'modular_babylon/master_files/icons/mob/body_markings/secondary_markings.dmi'
...
/datum/body_marking/tertiary
	icon = 'modular_babylon/master_files/icons/mob/body_markings/tertiary_markings.dmi'
...
/datum/body_marking/tattoo
	icon = 'modular_babylon/master_files/icons/mob/body_markings/tattoo_markings.dmi'
	recommended_species = null
