...
/obj/item/clothing/head/standalone_hood
	...
	worn_icon = 'modular_babylon/modules/GAGS/icons/head/head.dmi'
	worn_icon_teshari = 'modular_babylon/modules/GAGS/icons/head/head_teshari.dmi'
...
/obj/item/clothing/head/skrell_chain
	...
	worn_icon = 'modular_babylon/master_files/icons/mob/clothing/head/skrell_chains.dmi'
