#define MODULAR_HANDS_ICON 'modular_babylon/master_files/icons/obj/clothing/gloves.dmi'
#define MODULAR_HANDS_WORN_ICON 'modular_babylon/master_files/icons/mob/clothing/hands.dmi'
