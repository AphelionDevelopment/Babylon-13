#define MODULAR_EYES_ICON 'modular_babylon/master_files/icons/obj/clothing/glasses.dmi'
#define MODULAR_EYES_WORN_ICON 'modular_babylon/master_files/icons/mob/clothing/eyes.dmi'
