...
/obj/item/clothing/mask/gas/respirator
	...
	worn_icon = 'modular_babylon/modules/GAGS/icons/masks.dmi'
...
/obj/item/clothing/mask/gas/clown_hat/vox
	...
	icon = 'modular_babylon/master_files/icons/mob/clothing/species/vox/mask.dmi'
	worn_icon = 'modular_babylon/master_files/icons/mob/clothing/species/vox/mask.dmi'
	worn_icon_better_vox = 'modular_babylon/master_files/icons/mob/clothing/species/vox/mask.dmi'
	worn_icon_vox = 'modular_babylon/master_files/icons/mob/clothing/species/vox/mask.dmi'
...
/obj/item/clothing/mask/gas/mime/vox/ui_action_click(mob/user)
	...
	if(src && choice && !user.incapacitated && in_range(user,src))
		...
		if(human_user.dna.mutant_bodyparts[FEATURE_SNOUT])
			icon = 'modular_babylon/master_files/icons/obj/clothing/masks.dmi'
			worn_icon = 'modular_babylon/master_files/icons/mob/clothing/mask_muzzled.dmi'
		else
			icon = 'modular_babylon/master_files/icons/mob/clothing/species/vox/mask.dmi'
			worn_icon = 'modular_babylon/master_files/icons/mob/clothing/species/vox/mask.dmi'
			icon_state = options[choice]
