// MODULAR SECURITY WEAR (NOT OVERRIDES, LOOK IN 'modular_babylon\modules\sec_haul\code\security_clothing\sec_clothing_overrides.dm')
...
/obj/item/clothing/under/rank/security/detective/cowboy
	...
	icon = 'modular_babylon/master_files/icons/donator/obj/clothing/uniform.dmi'	//Donator item-ish? See the /armorless one below it
...
/obj/item/clothing/under/rank/prisoner/classic
	...
	icon = 'modular_babylon/master_files/icons/obj/clothing/under/costume.dmi'
	worn_icon = 'modular_babylon/master_files/icons/mob/clothing/under/costume.dmi'
	worn_icon_digi = 'modular_babylon/master_files/icons/mob/clothing/under/costume_digi.dmi'
