...
/obj/item/cigarette/khi
	...
	icon = 'modular_babylon/master_files/icons/obj/clothing/masks.dmi'
	worn_icon = 'modular_babylon/master_files/icons/mob/clothing/mask.dmi'
	icon_state = "khioff"
	icon_on = "khion"
	icon_off = "khioff"
...
/obj/item/cigbutt/khi
	icon = 'modular_babylon/master_files/icons/obj/cigarettes_khi.dmi'
	icon_state = "khibutt"
	...
	switch(current_state)
		if(TURN_DIAL)
			user.visible_message(
				...
				vision_distance=2)
			playsound(user, 'modular_babylon/master_files/sound/effects/bab1.ogg', 100, TRUE)
			sparks.start()
		...
		if(TAP_SCREEN)
			user.visible_message(
				...
				vision_distance=2)
			playsound(user, 'modular_babylon/master_files/sound/effects/platform_call.ogg', 100, TRUE)
		...
		if(PRESS_KEYS)
			user.visible_message(
				...
				vision_distance=2)
			sparks.start()
			playsound(user, 'modular_babylon/master_files/sound/effects/gmalfunction.ogg', 100, TRUE)
		...
		if(SLAP_SIDE)
			user.visible_message(
				...
				vision_distance=2)
			playsound(user, 'modular_babylon/master_files/sound/effects/hacked.ogg', 100, TRUE)
			sparks.start()
...
/obj/item/nanite_leg_reinforcement
	...
	icon = 'modular_babylon/modules/modular_implants/icons/obj/nifs.dmi'
	icon_state = "base_nif"
...
/obj/item/clothing/glasses/hud/ar/projector/science/sqn
	...
	worn_icon = 'modular_babylon/master_files/icons/mob/clothing/under/misc.dmi'
...
/obj/item/instrument/piano_synth/headphones/catear_headphone
	...
	worn_icon = 'modular_babylon/modules/GAGS/icons/head/catear_headphone.dmi'
	lefthand_file = 'modular_babylon/modules/GAGS/icons/head/catear_headphone_inhand.dmi'
	righthand_file = 'modular_babylon/modules/GAGS/icons/head/catear_headphone_inhand.dmi'
...
/obj/item/instrument/piano_synth/headphones/catear_headphone/worn_overlays(mutable_appearance/standing, isinhands, icon_file)
	. = ..()
	if(!isinhands)
		. += emissive_appearance('modular_babylon/modules/GAGS/icons/head/catear_headphone.dmi', "catearphones_[song?.playing ? "on" : "off"]_emissive", src, alpha = src.alpha)
		if(catTailToggled)
			. += emissive_appearance('modular_babylon/modules/GAGS/icons/head/catear_headphone.dmi', "catearphones_tail_on_emissive", src, alpha = src.alpha)
...
/obj/item/instrument/piano_synth/headphones/catear_headphone/update_overlays()
	. = ..()
	. += emissive_appearance('modular_babylon/modules/GAGS/icons/head/catear_headphone.dmi', "catearphones_obj_lights_emissive", src, alpha = src.alpha)
...
/obj/item/storage/backpack/merctac_backpack
	...
	icon = 'modular_babylon/master_files/icons/donator/obj/clothing/back.dmi'
	worn_icon = 'modular_babylon/master_files/icons/donator/mob/clothing/back.dmi'
...
/obj/item/gun/ballistic/automatic/miecz/ak105
	...
	icon = 'modular_babylon/master_files/icons/donator/obj/guns48x.dmi'
	icon_state = "ak105sbr"
	worn_icon = 'modular_babylon/master_files/icons/donator/mob/worn/weapons.dmi'
...
/obj/item/toy/pillow/torapillow
	...
	lefthand_file = 'modular_babylon/master_files/icons/donator/mob/inhands/donator_left.dmi'
	righthand_file = 'modular_babylon/master_files/icons/donator/mob/inhands/donator_right.dmi'
	icon = 'modular_babylon/master_files/icons/donator/obj/torabod_pillow.dmi'
	throw_range = 1
