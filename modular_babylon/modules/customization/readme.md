...
IF YOU WANT TO ADD AN EXTRA FEATURE TO SOMEONES DNA LOOK AT "`code\__DEFINES\~babylon_defines\DNA.dm"`
...
`.\code\__DEFINES\~babylon_defines\DNA.dm` > A TON of defines`
`.\code\_\_DEFINES\~babylon_defines\obj_flags.dm` > Organ flags`
`.\code\__DEFINES\~babylon_defines\say.dm` > MAX_FLAVOR_LEN`
`.\code\_\_DEFINES\~babylon_defines\traits.dm` > TRAIT_NO_HUSK`

.\modular_babylon\modules\customization\modules\reagents\chemistry\reagents.dm > var\process_flags

### Master file additions

.\modular_babylon\master_files\icons\mob\clothing\eyes_vox.dmi
.\modular_babylon\master_files\icons\mob\clothing\feet_digi.dmi
.\modular_babylon\master_files\icons\mob\clothing\head_muzzled.dmi
.\modular_babylon\master_files\icons\mob\clothing\head_vox.dmi
.\modular_babylon\master_files\icons\mob\clothing\mask_muzzled.dmi
.\modular_babylon\master_files\icons\mob\clothing\mask_vox.dmi
.\modular_babylon\master_files\icons\mob\clothing\suit_digi.dmi
.\modular_babylon\master_files\icons\mob\clothing\suit_taur_hoof.dmi
.\modular_babylon\master_files\icons\mob\clothing\suit_taur_paw.dmi
.\modular_babylon\master_files\icons\mob\clothing\suit_taur_snake.dmi
.\modular_babylon\master_files\icons\mob\clothing\uniform_digi.dmi
.\modular_babylon\master_files\icons\mob\clothing\under\uniform_digi.dmi
.\modular_babylon\master_files\icons\mob\clothing\under\uniform_taur_hoof.dmi
.\modular_babylon\master_files\icons\mob\clothing\under\uniform_taur_paw.dmi
.\modular_babylon\master_files\icons\mob\clothing\under\uniform_taur_snake.dmi

.\modular_babylon\master_files\icons\obj\drinks.dmi
