...
/datum/robotic_style/scrappyipc
	name = "Scrappy"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/scrappyipc.dmi' // for ones that don't have associated limb atoms just setting icon works fine
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/scrappyipc_greyscale
	name = "Scrappy (Greyscale)"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/scrappyipc_greyscale.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE
...
/datum/robotic_style/mcgipc
	...
	icon = 'modular_babylon/master_files/icons/mob/augmentation/mcgipc.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/bshipc
	name = "Bishop Cyberkinetics"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/bshipc.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/bs2ipc
	name = "Bishop Cyberkinetics 2.0"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/bs2ipc.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/e3n
	name = "E3N AI"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/e3n.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/hsiipc
	name = "Hephaestus Industries"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/hsiipc.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/hi2ipc
	name = "Hephaestus Industries 2.0"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/hi2ipc.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/sgmipc
	name = "Shellguard Munitions Standard Series"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/sgmipc.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/wtmipc
	name = "Ward-Takahashi Manufacturing"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/wtmipc.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/xmgipc
	name = "Xion Manufacturing Group"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/xmgipc.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/xm2ipc
	name = "Xion Manufacturing Group 2.0"
	icon ='modular_babylon/master_files/icons/mob/augmentation/xm2ipc.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/zhpipc
	name = "Zeng-Hu Pharmaceuticals"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/zhpipc.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/mariinskyipc
	name = "Mariinsky Ballet Company"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/mariinskyipc.dmi'
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE

/datum/robotic_style/zhenkovipc
	name = "Zhenkov & Co. Foundries"
	icon = 'modular_babylon/master_files/icons/mob/augmentation/zhenkovipc.dmi'
...
/datum/robotic_style/zhenkovipc_dark
	...
	icon = 'modular_babylon/master_files/icons/mob/augmentation/zhenkovipc_dark.dmi'
	supported_slots = LEGS
	bodyshape_override = BODYSHAPE_HUMANOID
	has_digi = TRUE
