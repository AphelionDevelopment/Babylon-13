...
/datum/action/innate/constrict
	...
	button_icon = 'modular_babylon/modules/taur_mechanics/icons/ability.dmi'
...
/obj/structure/serpentine_tail
	...
	icon = 'modular_babylon/modules/taur_mechanics/icons/tail.dmi'
	icon_state = "naga"
	pixel_x = -16
...
/obj/structure/serpentine_tail/proc/add_tail_overlay()
	...
	tail_overlay = mutable_appearance('modular_babylon/modules/taur_mechanics/icons/tail.dmi', "naga_top", ABOVE_MOB_LAYER + 0.01, src)
...
/atom/movable/screen/alert/status_effect/constricted
	...
	icon = 'modular_babylon/modules/taur_mechanics/icons/ability.dmi'
