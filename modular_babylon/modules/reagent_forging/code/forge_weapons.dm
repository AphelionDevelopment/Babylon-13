...
/obj/item/forging/reagent_weapon
	icon = 'modular_babylon/modules/reagent_forging/icons/obj/forge_items.dmi'
	lefthand_file = 'modular_babylon/modules/reagent_forging/icons/mob/forge_weapon_l.dmi'
	righthand_file = 'modular_babylon/modules/reagent_forging/icons/mob/forge_weapon_r.dmi'
	worn_icon = 'modular_babylon/modules/reagent_forging/icons/mob/forge_weapon_worn.dmi'
