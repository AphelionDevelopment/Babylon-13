/obj/structure/reagent_anvil
	...
	icon = 'modular_babylon/modules/reagent_forging/icons/obj/forge_structures.dmi'
...
/obj/structure/reagent_anvil/hammer_act(mob/living/user, obj/item/tool)
	...
	if(locate_obj && (locate_obj.obj_flags_nova & ANVIL_REPAIR))
		...
		while(locate_obj.get_integrity() < locate_obj.max_integrity)
			...
			playsound(src, 'modular_babylon/modules/reagent_forging/sound/forge.ogg', 50, TRUE, ignore_walls = FALSE)
