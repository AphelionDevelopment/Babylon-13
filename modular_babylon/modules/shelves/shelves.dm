...
/obj/structure/cargo_shelf //Crate shelf port from Shiptest: https://github.com/shiptest-ss13/Shiptest/pull/2374
	...
	icon = 'modular_babylon/modules/shelves/structures.dmi'
...
/obj/structure/cargo_shelf/Initialize(mapload)
	...
	for(var/i in 1 to (capacity - 1))
		...
		var/mutable_appearance/shelf_overlay = mutable_appearance('modular_babylon/modules/shelves/structures.dmi', "shelf_stack", layer = stack_layer)
