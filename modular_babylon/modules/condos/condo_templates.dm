...
/datum/map_template/condo/dstwo_condo
	...
	mappath = "modular_babylon/modules/condos/_maps/dstwo_condo.dmm"
	landing_zone_x_offset = 7
	landing_zone_y_offset = 2

/datum/map_template/condo/beach_condo
	name = "Condo - Beachside"
	mappath = "modular_babylon/modules/condos/_maps/beach_condo.dmm"
	landing_zone_x_offset = 7
	landing_zone_y_offset = 2

/datum/map_template/condo/gm_condo
	name = "Condo - Suite"
	mappath = "modular_babylon/modules/condos/_maps/gm_condo.dmm"
