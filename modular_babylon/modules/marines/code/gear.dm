/obj/item/gun/ballistic/automatic/ar/modular/m44a
	...
	icon = 'modular_babylon/modules/marines/icons/m44a.dmi'
	righthand_file = 'modular_babylon/modules/marines/icons/m44a_r.dmi'
	lefthand_file = 'modular_babylon/modules/marines/icons/m44a_l.dmi'
	fire_sound = 'modular_babylon/modules/marines/sound/m44a.ogg'
	fire_delay = 1
	burst_size = 3
	spread = 6
