...
- `modular_babylon/modules/knotting/code/knotted_component.dm`: `KNOT_DEFAULT_DURATION`, `KNOT_MIN_DURATION`, `KNOT_MAX_DURATION`
...
- `modular_babylon/modules/modular_items/lewd_items/code/lewd_arousal/climax.dm`: Calls `try_knot()` after an internal climax.
