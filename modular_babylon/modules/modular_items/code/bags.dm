...
/obj/item/storage/pouch
	...
	icon = 'modular_babylon/modules/modular_items/icons/storage.dmi'
	icon_state = "survival"
...
/datum/storage/pouch/medical/small
	...
	here's a thought: the pocket first aid kit from the colonial replicator [modular_babylon\modules\food_replicator\code\storage.dm] has
