/obj/item/crucifix
	...
	icon = 'modular_babylon/modules/modular_items/icons/crucifix.dmi'
	icon_state = "cross_ornate"
	lefthand_file = 'modular_babylon/modules/modular_items/icons/cross_left.dmi'
	righthand_file = 'modular_babylon/modules/modular_items/icons/cross_right.dmi'
