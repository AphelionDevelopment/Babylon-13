/obj/structure/bed/double/pelt/synthetic
	...
	icon = 'modular_babylon/modules/tribal_extended/icons/tribal_beds.dmi'
	anchored = TRUE
	can_buckle = TRUE
	buckle_lying = 90
...
/obj/structure/bed/oversized
	...
	icon = 'modular_babylon/master_files/icons/obj/medieval/structures_64x64.dmi'
	icon_state = "bed_1x2"
	anchored = TRUE
	can_buckle = TRUE
	buckle_lying = 90
...
/obj/structure/bed/oversized/triple
	...
	icon = 'modular_babylon/master_files/icons/obj/medieval/structures_96x96.dmi'
	icon_state = "bed_3x3"
	max_buckled_mobs = 4
