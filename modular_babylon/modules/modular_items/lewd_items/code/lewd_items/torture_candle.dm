...
/obj/item/bdsm_candle/attack(mob/living/carbon/human/attacked, mob/living/carbon/human/user)
	...
	playsound_if_pref(loc, pick('modular_babylon/modules/modular_items/lewd_items/sounds/vax1.ogg',
						'modular_babylon/modules/modular_items/lewd_items/sounds/vax2.ogg'), 70, TRUE)
