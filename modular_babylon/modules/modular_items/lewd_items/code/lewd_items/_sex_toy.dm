/obj/item/clothing/sextoy
	...
	equip_sound = 'modular_babylon/modules/modular_items/lewd_items/sounds/bang1.ogg'
	drop_sound = 'modular_babylon/modules/modular_items/lewd_items/sounds/bang2.ogg'
	...
	/// See code/__DEFINES/~babylon_defines/inventory.dm for the full list.
