...
/obj/item/clothing/mask/leatherwhip
	...
	icon = 'modular_babylon/modules/modular_items/lewd_items/icons/obj/lewd_items/lewd_items.dmi'
	worn_icon = 'modular_babylon/modules/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_masks.dmi'
	worn_icon_muzzled = 'modular_babylon/modules/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_masks_muzzled.dmi'
...
/obj/item/clothing/mask/leatherwhip/proc/handle_speech(datum/source, list/speech_args)
	...
	playsound_if_pref(loc, pick('modular_babylon/modules/modular_items/lewd_items/sounds/under_moan_f1.ogg',
						'modular_babylon/modules/modular_items/lewd_items/sounds/under_moan_f2.ogg',
						'modular_babylon/modules/modular_items/lewd_items/sounds/under_moan_f3.ogg',
						'modular_babylon/modules/modular_items/lewd_items/sounds/under_moan_f4.ogg'), 70, 1, -1)
...
/obj/item/clothing/mask/leatherwhip/equipped(mob/target, slot)
	...
	whip_overlay = mutable_appearance('modular_babylon/modules/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_masks.dmi', "[base_icon_state]_[current_whip_form]", ABOVE_MOB_LAYER + 0.1) //two arguments. Yes, all mob layer. Fuck person who was working on genitals, they're working wrong.ABOVE_NORMAL_TURF_LAYER
...
//and there is code for successful check, so we are whipping someone
	...
	switch(user.zone_selected) //to let code know what part of body we gonna whip
		...
		if(BODY_ZONE_HEAD)
			...
			target.adjust_pain(5)
			playsound_if_pref(loc, 'modular_babylon/modules/modular_items/lewd_items/sounds/latex.ogg', 80)
