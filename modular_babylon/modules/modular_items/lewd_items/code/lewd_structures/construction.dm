...
/obj/item/construction_kit/pole
	icon = 'modular_babylon/modules/modular_items/lewd_items/icons/obj/lewd_structures/dancing_pole.dmi'
	icon_state = "pole_base"
	resulting_structure = /obj/structure/stripper_pole

// BDSM FURNITURE
/obj/item/construction_kit/bdsm
	icon = 'modular_babylon/modules/modular_items/lewd_items/icons/obj/lewd_structures/bdsm_furniture.dmi'
