...
/obj/effect/temp_visual/feathers
	name = "feathers"
	icon_state = "feathers"
	icon = 'modular_babylon/modules/modular_items/lewd_items/icons/obj/lewd_decals/lewd_decals.dmi'
	duration = 14
...
/obj/item/fancy_pillow/attack(mob/living/carbon/human/affected_mob, mob/living/carbon/human/user)
	...
	switch(user.zone_selected) //to let code know what part of body we gonna hit
		...
		if(BODY_ZONE_HEAD)
			...
			playsound(loc, 'modular_babylon/modules/modular_items/lewd_items/sounds/hug.ogg', 50, 1, -1)
...
/obj/structure/bed/pillow_tiny
	...
	icon = 'modular_babylon/modules/modular_items/lewd_items/icons/obj/lewd_structures/pillows.dmi'
	icon_state = "pillow_pink_round"
	base_icon_state = "pillow"
	elevation = 0
	var/current_color = "pink"
...
/obj/structure/bed/pillow_large/update_overlays()
	. = ..()
	if(has_buckled_mobs())
		. += mutable_appearance('modular_babylon/modules/modular_items/lewd_items/icons/obj/lewd_structures/pillows.dmi', "pillowpile_large_[current_color]_overlay", layer = ABOVE_MOB_LAYER + 0.2)
