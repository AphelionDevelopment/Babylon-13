/obj/item/clothing/suit/straight_jacket/kinky_sleepbag
	...
	worn_icon = 'modular_babylon/modules/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_suit/sleepbag_normal.dmi'
	worn_icon_digi = 'modular_babylon/modules/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_suit/sleepbag_digi.dmi'
	worn_icon_taur_snake = 'modular_babylon/modules/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
	worn_icon_taur_paw = 'modular_babylon/modules/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
	worn_icon_taur_hoof = 'modular_babylon/modules/modular_items/lewd_items/icons/mob/lewd_clothing/lewd_suit/sleepbag_special.dmi'
...
/obj/item/clothing/suit/straight_jacket/kinky_sleepbag/process(seconds_per_tick)
	if(time_to_sound_left <= 0)
		if(tt <= 0)
			playsound_if_pref(loc, 'modular_babylon/modules/modular_items/lewd_items/sounds/latex.ogg', 100, TRUE)
