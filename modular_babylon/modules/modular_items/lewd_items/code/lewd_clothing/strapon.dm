...
/obj/item/clothing/strapon/proc/update_mob_action_buttonss()
	for(var/datum/action/item_action/take_strapon/action_button in actions_types)
		...
		action_button.button_icon = 'modular_babylon/modules/modular_items/lewd_items/icons/obj/lewd_items/lewd_items.dmi'
	update_appearance(UPDATE_ICON)
	...
	switch(user.zone_selected)
		if(BODY_ZONE_PRECISE_GROIN)
			...
			playsound_if_pref(loc, pick(
				'modular_babylon/modules/modular_items/lewd_items/sounds/bang1.ogg',
				...
				'modular_babylon/modules/modular_items/lewd_items/sounds/bang6.ogg'), 60, TRUE)
		...
		if(BODY_ZONE_HEAD, BODY_ZONE_PRECISE_MOUTH, BODY_ZONE_PRECISE_EYES)
			...
			playsound_if_pref(loc, pick(
				...
				'modular_babylon/modules/modular_items/lewd_items/sounds/bang4.ogg',
				'modular_babylon/modules/modular_items/lewd_items/sounds/bang5.ogg',
				'modular_babylon/modules/modular_items/lewd_items/sounds/bang6.ogg'), 40, TRUE)
