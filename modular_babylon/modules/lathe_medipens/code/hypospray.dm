/obj/item/reagent_containers/hypospray/medipen/universal
	...
	icon = 'modular_babylon/modules/lathe_medipens/icons/syringe.dmi'
	lefthand_file = 'modular_babylon/modules/lathe_medipens/icons/medical_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/lathe_medipens/icons//medical_righthand.dmi'
...
/obj/item/reagent_containers/hypospray/medipen/universal/proc/update_reagent_overlay()
	if(!reagents?.total_volume)
		return
	var/mutable_appearance/filling_overlay = mutable_appearance('modular_babylon/modules/lathe_medipens/icons/reagent_fillings.dmi', "medipen")
...
/obj/item/reagent_containers/hypospray/medipen/universal/lowpressure/update_reagent_overlay()
	...
	var/mutable_appearance/filling_overlay = mutable_appearance('modular_babylon/modules/lathe_medipens/icons/reagent_fillings.dmi', overlay_icon)
	filling_overlay.color = mix_color_from_reagents(reagents.reagent_list)
	. += filling_overlay
