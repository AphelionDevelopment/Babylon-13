...
/obj/item/hypospray/mkii
	...
	icon_state = "hypo2"
	icon = 'modular_babylon/modules/hyposprays/icons/hyposprays.dmi'
	...
	var/original_icon = 'modular_babylon/modules/hyposprays/icons/hyposprays.dmi'
...
/obj/item/hypospray/mkii/proc/do_inject(mob/living/injectee, mob/living/user, mode)
	...
	playsound(loc, long_sound ? 'modular_babylon/modules/hyposprays/sound/hypospray_long.ogg' : pick('modular_babylon/modules/hyposprays/sound/hypospray.ogg','modular_babylon/modules/hyposprays/sound/hypospray2.ogg'), 50, 1, -1)
