...
#define DEFAULT_TITLE_SCREEN_IMAGE 'modular_babylon/modules/title_screen/icons/nova_sector_title_screen.png'
#define DEFAULT_TITLE_LOADING_SCREEN 'modular_babylon/modules/title_screen/icons/loading_screen.gif'
