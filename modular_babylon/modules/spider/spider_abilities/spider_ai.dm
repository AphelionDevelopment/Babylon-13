...
/datum/ai_controller/basic_controller/webslinger
	behavior_tree_json = "modular_babylon/modules/spider/spider_abilities/webslinger.bt.json"
	blackboard = list(
...
/datum/ai_controller/basic_controller/voltaic
	behavior_tree_json = "modular_babylon/modules/spider/spider_abilities/voltaic.bt.json"
	blackboard = list(
		BB_TARGETING_STRATEGY = /datum/targeting_strategy/basic,
	)
...
/datum/ai_controller/basic_controller/pit
	behavior_tree_json = "modular_babylon/modules/spider/spider_abilities/pit.bt.json"
	blackboard = list(
		BB_TARGETING_STRATEGY = /datum/targeting_strategy/basic,
	)
...
/datum/ai_controller/basic_controller/carrier
	behavior_tree_json = "modular_babylon/modules/spider/spider_abilities/carrier.bt.json"
	blackboard = list(
		BB_TARGETING_STRATEGY = /datum/targeting_strategy/basic,
	)
...
/datum/ai_controller/basic_controller/ogre
	behavior_tree_json = "modular_babylon/modules/spider/spider_abilities/ogre.bt.json"
	blackboard = list(
		BB_TARGETING_STRATEGY = /datum/targeting_strategy/basic,
	)
...
/datum/ai_controller/basic_controller/baron
	behavior_tree_json = "modular_babylon/modules/spider/spider_abilities/baron.bt.json"
	blackboard = list(
		BB_TARGETING_STRATEGY = /datum/targeting_strategy/basic,
	)
...
/datum/ai_controller/basic_controller/badnana
	behavior_tree_json = "modular_babylon/modules/spider/spider_abilities/badnana.bt.json"
	blackboard = list(
		BB_TARGETING_STRATEGY = /datum/targeting_strategy/basic,
	)
