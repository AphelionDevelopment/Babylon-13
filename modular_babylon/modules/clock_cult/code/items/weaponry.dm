...
/obj/item/clockwork/weapon
	...
	desc = "Something"
	icon = 'modular_babylon/modules/clock_cult/icons/weapons/clockwork_weapons.dmi'
	lefthand_file = 'modular_babylon/modules/clock_cult/icons/weapons/clockwork_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/clock_cult/icons/weapons/clockwork_righthand.dmi'
	worn_icon = 'modular_babylon/modules/clock_cult/icons/clockwork_garb_worn.dmi'
...
/obj/item/gun/ballistic/bow/clockwork/attack_self(mob/living/user)
	...
	drawn = TRUE
	playsound(src, 'modular_babylon/modules/tribal_extended/sound/sound_weapons_bowdraw.ogg', 75, 0) //gets way too high pitched if the freq varies
	update_icon()
...
/obj/item/ammo_casing/arrow/clockbolt
	...
	icon = 'modular_babylon/modules/clock_cult/icons/weapons/ammo.dmi'
	icon_state = "arrow_redlight"
	projectile_type = /obj/projectile/energy/clockbolt

/obj/projectile/energy/clockbolt
	name = "energy bolt"
	icon = 'modular_babylon/modules/clock_cult/icons/projectiles.dmi'
...
/obj/item/gun/ballistic/rifle/lionhunter/clockwork
	...
	icon = 'modular_babylon/modules/clock_cult/icons/weapons/clockwork_weapons_40x32.dmi'
	lefthand_file = 'modular_babylon/modules/clock_cult/icons/weapons/clockwork_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/clock_cult/icons/weapons/clockwork_righthand.dmi'
	worn_icon = 'modular_babylon/modules/clock_cult/icons/clockwork_garb_worn.dmi'
	slot_flags = ITEM_SLOT_BACK
