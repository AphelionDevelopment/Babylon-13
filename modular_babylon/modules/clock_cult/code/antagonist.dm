...
/datum/antagonist/clock_cultist/on_gain()
	. = ..()
	owner.current.playsound_local(get_turf(owner.current), 'modular_babylon/modules/clock_cult/sound/magic/scripture_tier_up.ogg', 100, FALSE, pressure_affected = FALSE, use_reverb = FALSE)
