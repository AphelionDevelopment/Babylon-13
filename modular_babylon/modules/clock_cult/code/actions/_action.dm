/datum/action/innate/clockcult
	button_icon = 'modular_babylon/modules/clock_cult/icons/actions_clock.dmi'
	background_icon = 'modular_babylon/modules/clock_cult/icons/background_clock.dmi'
...
/datum/action/item_action/toggle/clock
	button_icon = 'modular_babylon/modules/clock_cult/icons/background_clock.dmi'
	background_icon_state = "bg_clock"
