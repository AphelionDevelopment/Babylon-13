...
/mob/living/basic/clockwork_marauder
	...
	icon = 'modular_babylon/modules/clock_cult/icons/clockwork_mobs.dmi'
...
/mob/living/basic/clockwork_marauder/proc/damage_shield()
	shield_health--
	playsound(src, 'modular_babylon/modules/clock_cult/sound/magic/anima_fragment_attack.ogg', 60, TRUE)
	if(!shield_health)
...
/datum/ai_controller/basic_controller/clockwork_marauder
	behavior_tree_json = "modular_babylon/modules/clock_cult/code/mobs/clockwork_marauder.bt.json"
	blackboard = list(
