...
/obj/structure/destructible/clockwork/gear_base/powered/ocular_warden/process(seconds_per_tick)
	...
	playsound(src, 'modular_babylon/modules/clock_cult/sound/machinery/ocularwarden-target.ogg', 60, TRUE)
	...
	playsound(target, pick('modular_babylon/modules/clock_cult/sound/machinery/ocularwarden-dot1.ogg', 'modular_babylon/modules/clock_cult/sound/machinery/ocularwarden-dot2.ogg'), 60, TRUE)
