/obj/item/gun/energy/taser/crank
	...
	icon = 'modular_babylon/modules/novaya_ert/icons/taser.dmi'
	icon_state = "crank_taser"
	lefthand_file = 'modular_babylon/modules/novaya_ert/icons/taser_left.dmi'
	righthand_file = 'modular_babylon/modules/novaya_ert/icons/taser_right.dmi'
...
/obj/item/gun/energy/taser/crank/Initialize(mapload)
	...
	AddComponent( \
		...
		charge_sound = 'modular_babylon/modules/new_cells/sound/crank.ogg', \
