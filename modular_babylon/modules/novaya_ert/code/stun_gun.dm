/obj/item/melee/baton/security/stun_gun
	...
	icon = 'modular_babylon/modules/novaya_ert/icons/stun_gun.dmi'
	icon_state = "stun_gun"
	lefthand_file = 'modular_babylon/modules/novaya_ert/icons/stun_gun_left.dmi'
	righthand_file = 'modular_babylon/modules/novaya_ert/icons/stun_gun_right.dmi'
...
/obj/item/melee/baton/security/stun_gun/stun_knife
	...
	icon = 'modular_babylon/modules/novaya_ert/icons/stun_knife.dmi'
	icon_state = "stun_knife"
	lefthand_file = 'modular_babylon/modules/novaya_ert/icons/stun_knife_left.dmi'
	righthand_file = 'modular_babylon/modules/novaya_ert/icons/stun_knife_right.dmi'
