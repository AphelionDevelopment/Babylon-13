/obj/item/shield/riot/pointman/nri
	...
	icon_state = "riot"
	icon = 'modular_babylon/modules/novaya_ert/icons/riot.dmi'
	lefthand_file = 'modular_babylon/modules/novaya_ert/icons/riot_left.dmi'
	righthand_file = 'modular_babylon/modules/novaya_ert/icons/riot_right.dmi'
	transparent = FALSE
