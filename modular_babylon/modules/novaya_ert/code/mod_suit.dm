/datum/mod_theme/rim_inspector
	...
	variants = list(
		"rim_inspector" = list(
			MOD_ICON_OVERRIDE = 'modular_babylon/modules/novaya_ert/icons/mod.dmi',
			MOD_WORN_ICON_OVERRIDE = 'modular_babylon/modules/novaya_ert/icons/wornmod.dmi',
...
/obj/item/mod/module/status_readout/operational
	...
	display_time = TRUE
	death_sound = 'modular_babylon/modules/novaya_ert/sound/flatline.ogg'
...
/obj/item/crafting_conversion_kit/voskhod_refit
	...
	force = 10
	icon = 'modular_babylon/modules/novaya_ert/icons/refit_kit.dmi'
...
/obj/effect/spawner/random/voskhod_refit
	...
	icon = 'modular_babylon/master_files/icons/obj/clothing/modsuit/mod_clothing.dmi'
