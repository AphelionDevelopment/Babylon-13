...
/obj/item/mecha_parts/mecha_equipment/weapon/ballistic/cannon
	...
	icon = 'modular_babylon/modules/novaya_ert/icons/mech.dmi'
	icon_state = "mecha_cannon"
	equip_cooldown = 2 SECONDS
	fire_sound = 'modular_babylon/modules/novaya_ert/sound/shell_out_med.ogg'
...
/obj/item/mecha_parts/mecha_equipment/weapon/ballistic/cannon/proc/call_load()
	...
	playsound(chassis, 'modular_babylon/modules/colony_fabricator/sound/fabricator/fabricator_mid_2.wav', 50, TRUE)
...
/obj/item/mecha_parts/mecha_equipment/weapon/ballistic/cannon/proc/call_loading()
	...
	playsound(chassis, 'modular_babylon/modules/novaya_ert/sound/servo.ogg', 50, TRUE)
...
/obj/item/mecha_parts/mecha_equipment/weapon/ballistic/cannon/proc/call_ready()
	...
	playsound(chassis, 'modular_babylon/modules/novaya_ert/sound/shell_in_med.ogg', 50, TRUE)
	ready_to_fire = TRUE
...
/obj/projectile/bullet/tank_cannon/heap/proc/fuse_activation(atom/target)
	...
	playsound(src, 'modular_babylon/modules/modular_weapons/sounds/grenade_burst.ogg', 100, FALSE, 3)
	qdel(shrapnel_maker)
