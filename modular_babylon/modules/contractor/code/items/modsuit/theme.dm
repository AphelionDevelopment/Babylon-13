/datum/mod_theme/contractor
	...
	variants = list(
		"contractor" = list(
			MOD_ICON_OVERRIDE = 'modular_babylon/modules/contractor/icons/modsuit.dmi',
			MOD_WORN_ICON_OVERRIDE = 'modular_babylon/modules/contractor/icons/worn_modsuit.dmi',
