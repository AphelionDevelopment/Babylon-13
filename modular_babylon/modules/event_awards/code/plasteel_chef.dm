...
/obj/item/knife/kitchen/plasteel_chef
	name = "émincer"
	icon = 'modular_babylon/modules/event_awards/icons/kitchen.dmi'
	lefthand_file = 'modular_babylon/modules/event_awards/icons/kitchen_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/event_awards/icons/kitchen_righthand.dmi'
