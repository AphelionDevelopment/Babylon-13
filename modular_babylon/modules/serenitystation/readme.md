...
- `modular_babylon/modules/aesthetics/floors/icons/floors.dmi` -> added mushroom turf icon
- `modular_babylon/modules/automapper/code/area_spawn_subsystem.dm `-> added SerenityStation to the automapper's blacklisted stations
- `modular_babylon/modules/mapping/code/areas/shuttles.dm `-> added the area for the planetary_ferry
- `modular_babylon/modules/mapping/code/areas/station.dm` -> added the areas used in the station (as these might be reused in mapping; forest-related areas are in the module's folder)
- `modular_babylon/modules/mapping/code/shuttles.dm` -> added map_template and computer for the planetary feery
- `modular_babylon/modules/mapping/code/vgdecals.dm` -> added BZ floor decals
- `modular_babylon/modules/mapping/icons/areas/areas_station.dmi` -> added icons for new station areas (cargo projects room, orbital areas, cyborg storage)
- `modular_babylon/modules/mapping/icons/turf/decals/vgstation_decals.dmi` -> added BZ floor decals
- `modular_babylon/master_files/sound/ambience/mushroom` -> Added ambience tracks for the Mushroom Caves.
- `modular_babylon/master_files/sound/ambience/forest` -> Added ambience tracks for the forest.
...
- `modular_babylon/master_files/code/controllers/subsystem/mapping.dm` -> added proc to return is_planetary_with_space maps
...
Credits to rick hick/tommy for all of the amazing ambience tracks that are found in modular_babylon/master_files/sound/ambience/mushroom and /forest!
