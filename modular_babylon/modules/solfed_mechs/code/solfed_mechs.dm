/obj/vehicle/sealed/mecha/solfed
	...
	icon = 'modular_babylon/modules/solfed_mechs/icons/solfed_mechs.dmi'
...
/datum/asset/spritesheet_batched/mecha_equipment/create_spritesheets()
	...
	insert_icon("rotary", uni_icon('modular_babylon/modules/solfed_mechs/icons/mecha_equipment.dmi', "rotary"))
