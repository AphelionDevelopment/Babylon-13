...
./modular_babylon/modules/gunpoint/code/datum/gunpoint/gunpoint.dm > /mob/living/ShiftMiddleClickOn() > CHILD PROC
...
./`code/__DEFINES/~babylon_defines/signals.dm` - COMSIG_MOVABLE_RADIO_TALK_INTO, COMSIG_LIVING_UPDATED_RESTING
./`code/__DEFINES/~babylon_defines/traits.dm` - TRAIT_NORUNNING
