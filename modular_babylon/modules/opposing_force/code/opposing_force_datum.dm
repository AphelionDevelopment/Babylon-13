...
/datum/opposing_force/proc/deny(mob/denier, reason = "")
	...
	SEND_SOUND(mind_reference.current, sound('modular_babylon/modules/opposing_force/sound/denied.ogg'))
...
/datum/opposing_force/proc/approve(mob/approver)
	...
	SEND_SOUND(mind_reference.current, sound('modular_babylon/modules/opposing_force/sound/approved.ogg'))
