...
/obj/item/mod/control/pre_equipped/protean/proc/set_distress_signal(enabled)
	cut_overlay(mutable_appearance('modular_babylon/modules/protean/icons/mob/species/protean/distress_light.dmi', "distress"))
	if(enabled)
		add_overlay(mutable_appearance('modular_babylon/modules/protean/icons/mob/species/protean/distress_light.dmi', "distress"))
