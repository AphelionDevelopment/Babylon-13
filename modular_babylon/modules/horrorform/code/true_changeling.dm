...
/mob/living/basic/true_changeling
	...
	icon = 'modular_babylon/modules/horrorform/icons/animal.dmi'
	icon_state = "horror"
	icon_living = "horror"
		...
		if(M && M.client)
			...
			if(M_turf && M_turf.z == src.z)
				...
				if(dist <= 7) //source of sound very close
					M.playsound_local(src, 'modular_babylon/modules/horrorform/sound/horror_scream.ogg', 80, 1, frequency)
				else
					var/vol = clamp(100-((dist-7)*5), 10, 100) //Every tile decreases sound volume by 5
					M.playsound_local(src, 'modular_babylon/modules/horrorform/sound/horror_scream_reverb.ogg', vol, 1, frequency)
...
/datum/ai_controller/basic_controller/true_changeling
	behavior_tree_json = "modular_babylon/modules/horrorform/code/true_changeling.bt.json"
	blackboard = list(
...
/obj/projectile/bullet/pellet/bone_fragment
	name = "bone fragment"
	icon = 'modular_babylon/modules/horrorform/icons/bone_fragment.dmi'
...
/datum/action/innate/turn_to_human
	...
	button_icon = 'modular_babylon/modules/horrorform/icons/actions_changeling.dmi'
	button_icon = 'modular_babylon/modules/horrorform/icons/actions_changeling.dmi'
...
/datum/action/innate/devour/Trigger(trigger_flags)
	...
	playsound(lunch, 'modular_babylon/modules/horrorform/sound/tear.ogg', 50, 1)
	lunch.emote("scream")
