...
/obj/item/storage/medkit/mechanical
	...
	icon = 'modular_babylon/modules/medical/icons/medkit.dmi'
	icon_state = "medkit_mechanical"
	inhand_icon_state = "medkit_mechanical"
	lefthand_file = 'modular_babylon/modules/medical/icons/medical_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/medical/icons/medical_righthand.dmi'
