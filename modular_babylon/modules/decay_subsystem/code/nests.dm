/obj/structure/mob_spawner
	...
	icon = 'modular_babylon/modules/decay_subsystem/icons/nests.dmi'
	icon_state = "nest"
	density = FALSE
	anchored = TRUE
	layer = TABLE_LAYER
...
/obj/structure/mob_spawner/proc/spawn_mob()
	var/sound/sound_to_play = pick('modular_babylon/master_files/sound/effects/rustle1.ogg', 'modular_babylon/master_files/sound/effects/rustle2.ogg')
...
/obj/item/spider_egg
	...
	icon = 'modular_babylon/modules/decay_subsystem/icons/loot.dmi'
