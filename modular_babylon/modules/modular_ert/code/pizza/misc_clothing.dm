...
/obj/item/clothing/under/pizza
	...
	icon = 'modular_babylon/master_files/icons/obj/clothing/under/centcom.dmi' //Dogginos is not technically affiliated with CC, but it's not OPPOSING it, and it's an "ERT"...
