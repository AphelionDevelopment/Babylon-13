...
/datum/atom_skin/crusher_skin/locked/ahabs_harpoon
	...
	new_icon = 'modular_babylon/modules/ahabs_spear/icons/ahabs_spear.dmi'
	new_icon_state = "crusher_ahab"
	new_inhand_icon_state = "crusher_ahab"
	new_projectile_icon = 'modular_babylon/modules/ahabs_spear/icons/ahabs_spear.dmi'
	new_projectile_icon_state = "crusher_ahab"
	new_inhand_icon_state = "crusher_ahab"
	new_projectile_icon = 'modular_babylon/modules/ahabs_spear/icons/projectiles.dmi'
	new_projectile_icon_state = "ahabprojectile"
	new_lefthand_file = 'modular_babylon/modules/ahabs_spear/icons/l_hand_ahab.dmi'
	new_righthand_file = 'modular_babylon/modules/ahabs_spear/icons/r_hand_ahab.dmi'
	new_worn_icon = 'modular_babylon/modules/ahabs_spear/icons/back.dmi'
...
/obj/item/crusher_trophy/retool_kit/ahab
	...
	icon = 'modular_babylon/modules/ahabs_spear/icons/ahabs_spear.dmi'
