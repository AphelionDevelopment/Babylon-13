/obj/item/clothing/head/hair_tie
	...
	icon = 'modular_babylon/modules/salon/icons/items.dmi'
	icon_state = "hairtie"
	worn_icon = 'modular_babylon/modules/salon/icons/items.dmi'
	worn_icon_state = "hair_tie_worn_no_icon"
	lefthand_file = 'modular_babylon/modules/salon/icons/items.dmi'
	righthand_file = 'modular_babylon/modules/salon/icons/items.dmi'
