/datum/mod_theme/jaeger_med
	...
	variants = list(
		"infantry" = list(
			MOD_ICON_OVERRIDE = 'modular_babylon/modules/jaeger_mod/icons/obj/infantry.dmi',
			MOD_WORN_ICON_OVERRIDE = 'modular_babylon/modules/jaeger_mod/icons/mob/infantry.dmi',
...
/obj/item/mod/module/jaeger_sprint
	...
	icon = 'modular_babylon/modules/jaeger_mod/icons/obj/infantry.dmi'
	icon_state = "sprint"
	removable = FALSE
