/obj/item/storage/box/coffee_tray
	...
	icon = 'modular_babylon/modules/bridge_assistant/icons/coffeeholder.dmi'
	icon_state = "holder"
	inhand_icon_state = "cawfeeinhand"
	lefthand_file = 'modular_babylon/modules/bridge_assistant/icons/coffeeholder_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/bridge_assistant/icons/coffeeholder_righthand.dmi'
