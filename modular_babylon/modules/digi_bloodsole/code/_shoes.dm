/obj/item/clothing/shoes/get_blood_overlay(blood_state, bodyshape)
	...
	if(clothing_flags & LARGE_WORN_ICON)
		blood_overlay = mutable_appearance('modular_babylon/modules/digi_bloodsole/icons/64x64.dmi', "shoeblood_large_digi")
	else
		blood_overlay = mutable_appearance('modular_babylon/modules/digi_bloodsole/icons/blood.dmi', "shoeblood_digi")
