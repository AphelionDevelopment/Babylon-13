/datum/species/synthetic/get_scream_sound(mob/living/carbon/human/synthetic)
	return 'modular_babylon/modules/emotes/sound/voice/scream_silicon.ogg'
...
/datum/species/lizard/get_scream_sound(mob/living/carbon/human/lizard)
	return pick(
		'modular_babylon/modules/emotes/sound/voice/scream_lizard.ogg',
...
/datum/species/skeleton/get_scream_sound(mob/living/carbon/human/skeleton)
	return 'modular_babylon/modules/emotes/sound/voice/scream_skeleton.ogg'
...
/datum/species/jelly/get_scream_sound(mob/living/carbon/human/jelly)
	return 'modular_babylon/modules/emotes/sound/emotes/jelly_scream.ogg'

/datum/species/vox/get_scream_sound(mob/living/carbon/human/vox)
	return 'modular_babylon/modules/emotes/sound/emotes/voxscream.ogg'
...
/datum/species/zombie/get_scream_sound(mob/living/carbon/human/teshari)
	return 'modular_babylon/modules/emotes/sound/emotes/zombie_scream.ogg'

/datum/species/teshari/get_scream_sound(mob/living/carbon/human/teshari)
	return 'modular_babylon/modules/emotes/sound/emotes/raptorscream.ogg'
