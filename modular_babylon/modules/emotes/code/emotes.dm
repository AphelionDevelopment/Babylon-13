...
/datum/emote/living/blush
	sound = 'modular_babylon/modules/emotes/sound/emotes/blush.ogg'
...
/datum/emote/living/quill
	...
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/emotes/voxrustle.ogg'


/datum/emote/living/cough/get_sound(mob/living/user)
	. = ..()
	if(isvox(user))
		return 'modular_babylon/modules/emotes/sound/emotes/voxcough.ogg'
	return
...
/datum/emote/living/sneeze/get_sound(mob/living/user)
	. = ..()
	if(isvox(user))
		return 'modular_babylon/modules/emotes/sound/emotes/voxsneeze.ogg'
	return
...
/datum/emote/living/peep
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/peep_once.ogg'
...
/datum/emote/living/peep2
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/peep.ogg'
...
/datum/emote/living/snap2
	...
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/snap2.ogg'
...
/datum/emote/living/snap3
	...
	hands_use_check = TRUE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/snap3.ogg'
...
/datum/emote/living/awoo
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/awoo.ogg'
...
/datum/emote/living/nya
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/nya.ogg'
...
/datum/emote/living/weh
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/weh.ogg'
...
/datum/emote/living/yip
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/fox_squeak.ogg'
...
/datum/emote/living/gecker
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/gecker.ogg'
...
/datum/emote/living/fwhine/get_sound(mob/living/user)
	return pick('modular_babylon/modules/emotes/sound/voice/fox1.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox2.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox3.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox4.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox5.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox6.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox7.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox8.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox9.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox10.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox11.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox12.ogg',
				'modular_babylon/modules/emotes/sound/voice/fox13.ogg')
...
/datum/emote/living/merp
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/merp.ogg'
...
/datum/emote/living/bark
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/bark2.ogg'
...
/datum/emote/living/squish
	...
	muzzle_ignore = TRUE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/slime_squish.ogg'
...
/datum/emote/living/bubble
	...
	muzzle_ignore = TRUE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/slime_bubble.ogg'
...
/datum/emote/living/pop
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/slime_pop.ogg'
...
/datum/emote/living/hiss/get_sound(mob/living/user)
	if(isxenohybrid(user))
		...
		return 'modular_babylon/modules/emotes/sound/emotes/hiss.ogg'
...
/datum/emote/living/sigh/get_sound(mob/living/user)
	if(iscarbon(user))
		if(user.gender == MALE)
			return 'modular_babylon/modules/emotes/sound/emotes/male/male_sigh.ogg'
		return 'modular_babylon/modules/emotes/sound/emotes/female/female_sigh.ogg'
	return
...
/datum/emote/living/snore
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/emotes/snore.ogg'
...
/datum/emote/living/burp/get_sound(mob/living/user)
	if(iscarbon(user))
		if(user.gender == MALE)
			return 'modular_babylon/modules/emotes/sound/emotes/male/burp_m.ogg'
		return 'modular_babylon/modules/emotes/sound/emotes/female/burp_f.ogg'
	return
...
/datum/emote/living/clap1/get_sound(mob/living/user)
	return pick('modular_babylon/modules/emotes/sound/emotes/claponce1.ogg',
				'modular_babylon/modules/emotes/sound/emotes/claponce2.ogg')
...
/datum/emote/beep
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/emotes/twobeep.ogg'
...
/datum/emote/living/bawk
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/bawk.ogg'
...
/datum/emote/living/caw
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/caw.ogg'
...
/datum/emote/living/caw2
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/caw2.ogg'
...
/datum/emote/living/bork
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/bork.ogg'
...
/datum/emote/living/hoot
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/hoot.ogg'
...
/datum/emote/living/growl
	...
	muzzle_ignore = TRUE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/growl.ogg'
	manual_specific_emote_audio_cooldown = 4 SECONDS
...
/datum/emote/living/woof
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/woof.ogg'
...
/datum/emote/living/baa
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/baa.ogg'
...
/datum/emote/living/baa2
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/baa2.ogg'
...
/datum/emote/living/wurble
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/wurble.ogg'
	manual_specific_emote_audio_cooldown = 4 SECONDS
...
/datum/emote/living/rattle
	...
	muzzle_ignore = TRUE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/rattle.ogg'
...
/datum/emote/living/cackle
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/cackle_yeen.ogg'
	manual_specific_emote_audio_cooldown = 5 SECONDS
...
/datum/emote/living/warble
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/warbles.ogg'
...
/datum/emote/living/trills
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/trills.ogg'
...
/datum/emote/living/rpurr
	...
	muzzle_ignore = TRUE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/raptor_purr.ogg'
...
/datum/emote/living/moo
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/moo.ogg'
...
/datum/emote/living/honk
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/goose_honk.ogg'
...
/datum/emote/living/mggaow
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/mggaow.ogg'
...
/datum/emote/living/mrrp
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/mrrp.ogg'
...
/datum/emote/living/prbt
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/prbt.ogg'
...
/datum/emote/living/sigh_exasperated/get_sound(mob/living/user)
	if(iscarbon(user))
		if(user.gender == MALE)
			return 'modular_babylon/modules/emotes/sound/emotes/male/male_sigh_exasperated.ogg'
		return 'modular_babylon/modules/emotes/sound/emotes/female/female_sigh_exasperated.ogg'
	return
...
/datum/emote/living/awuff
	...
	sound = 'modular_babylon/modules/emotes/sound/voice/awuff.ogg'
	emote_type = EMOTE_AUDIBLE
	vary = TRUE

/datum/emote/living/awuff/get_sound(mob/living/user)
	. = ..()
	return pick('modular_babylon/modules/emotes/sound/voice/awuff.ogg', 'modular_babylon/modules/emotes/sound/voice/awuff2.ogg', 'modular_babylon/modules/emotes/sound/voice/awuff3.ogg')
...
/datum/emote/living/arf
	...
	sound = 'modular_babylon/modules/emotes/sound/voice/arf.ogg'
	emote_type = EMOTE_AUDIBLE
	vary = TRUE

/datum/emote/living/arf/get_sound(mob/living/user)
	. = ..()
	return pick('modular_babylon/modules/emotes/sound/voice/arf.ogg', 'modular_babylon/modules/emotes/sound/voice/arf2.ogg', 'modular_babylon/modules/emotes/sound/voice/arf3.ogg')
...
/datum/emote/living/coyhowl
	...
	sound = 'modular_babylon/modules/emotes/sound/voice/coyotehowl.ogg'
...
/datum/emote/living/coyhowl/get_sound(mob/living/user)
	. = ..()
	return pick(
		'modular_babylon/modules/emotes/sound/voice/coyotehowl.ogg',
		'modular_babylon/modules/emotes/sound/voice/coyotehowl2.ogg',
		'modular_babylon/modules/emotes/sound/voice/coyotehowl3.ogg',
		'modular_babylon/modules/emotes/sound/voice/coyotehowl4.ogg',
		'modular_babylon/modules/emotes/sound/voice/coyotehowl5.ogg',
	)
...
/datum/emote/living/wolfhowl
	...
	sound = 'modular_babylon/modules/emotes/sound/voice/wolfhowl.ogg'
...
/datum/emote/living/wolfhowl/get_sound(mob/living/user)
	. = ..()
	return pick('modular_babylon/modules/emotes/sound/voice/wolfhowl.ogg', 'modular_babylon/modules/emotes/sound/voice/wolfhowl2.ogg', 'modular_babylon/modules/emotes/sound/voice/wolfhowl3.ogg')
...
/datum/emote/living/dwhine
	...
	sound = 'modular_babylon/modules/emotes/sound/voice/dwhine.ogg'
...
/datum/emote/living/dwhine/get_sound(mob/living/user)
	. = ..()
	return pick(
		'modular_babylon/modules/emotes/sound/voice/dwhine.ogg',
		'modular_babylon/modules/emotes/sound/voice/dwhine2.ogg',
		'modular_babylon/modules/emotes/sound/voice/dwhine3.ogg',
		'modular_babylon/modules/emotes/sound/voice/dwhine4.ogg',
		'modular_babylon/modules/emotes/sound/voice/dwhine5.ogg',
	)
...
/datum/emote/living/dgrowl
	...
	sound = 'modular_babylon/modules/emotes/sound/voice/dgrowl.ogg'
...
/datum/emote/living/dgrowl/get_sound(mob/living/user)
	. = ..()
	return pick(
		'modular_babylon/modules/emotes/sound/voice/dgrowl.ogg',
		'modular_babylon/modules/emotes/sound/voice/dgrowl2.ogg',
		'modular_babylon/modules/emotes/sound/voice/dgrowl3.ogg',
		'modular_babylon/modules/emotes/sound/voice/dgrowl4.ogg',
		'modular_babylon/modules/emotes/sound/voice/dgrowl5.ogg',
	)
...
/datum/emote/living/aggrobark
	...
	sound = 'modular_babylon/modules/emotes/sound/voice/aggrobark.ogg'
...
/datum/emote/living/aggrobark/get_sound(mob/living/user)
	. = ..()
	return pick('modular_babylon/modules/emotes/sound/voice/aggrobark.ogg', 'modular_babylon/modules/emotes/sound/voice/aggrobark2.ogg', 'modular_babylon/modules/emotes/sound/voice/aggrobark3.ogg', 'modular_babylon/modules/emotes/sound/voice/aggrobark4.ogg')
...
/datum/emote/living/dcomplain
	...
	sound = 'modular_babylon/modules/emotes/sound/voice/dcomplain.ogg'
...
/datum/emote/living/dcomplain/get_sound(mob/living/user)
	. = ..()
	return pick(
		'modular_babylon/modules/emotes/sound/voice/dcomplain.ogg',
		'modular_babylon/modules/emotes/sound/voice/dcomplain2.ogg',
		'modular_babylon/modules/emotes/sound/voice/dcomplain3.ogg',
		'modular_babylon/modules/emotes/sound/voice/dcomplain4.ogg',
		'modular_babylon/modules/emotes/sound/voice/dcomplain5.ogg',
	)
...
/datum/emote/living/meowdeep
	...
	sound = 'modular_babylon/modules/emotes/sound/voice/meowdeep.ogg'
	emote_type = EMOTE_AUDIBLE
	vary = TRUE

/datum/emote/living/meowdeep/get_sound(mob/living/user)
	. = ..()
	return pick('modular_babylon/modules/emotes/sound/voice/meowdeep.ogg', 'modular_babylon/modules/emotes/sound/voice/meowdeep2.ogg', 'modular_babylon/modules/emotes/sound/voice/meowdeep3.ogg')
...
/datum/emote/living/teshchirp
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/teshchirp.ogg' // Credits to Virgo Station for the files.
...
/datum/emote/living/teshsqueak
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/teshsqueak.ogg' // Credits to Virgo Station for the files.
...
/datum/emote/living/teshtrill
	...
	emote_type = EMOTE_AUDIBLE
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/teshtrill.ogg' // Credits to Virgo Station for the files.
...
/datum/emote/living/gulp/get_sound(mob/living/user)
	return pick(
		'modular_babylon/modules/emotes/sound/voice/gulp1.ogg',
		'modular_babylon/modules/emotes/sound/voice/gulp2.ogg',
	)

/datum/emote/living/carbon/wink
	sound = 'modular_babylon/modules/emotes/sound/voice/wink.ogg'

/datum/emote/living/carbon/human/blink
	sound = 'modular_babylon/modules/emotes/sound/voice/blink.ogg'
...
/datum/emote/living/mar
	...
	vary = TRUE
	sound = 'modular_babylon/modules/emotes/sound/voice/mar.ogg'
