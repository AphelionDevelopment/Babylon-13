...
/datum/scream_type/human/female
	...
	scream_sounds = list(
		'modular_babylon/modules/emotes/sound/voice/scream_f1.ogg',
		'modular_babylon/modules/emotes/sound/voice/scream_f2.ogg',
		'modular_babylon/modules/emotes/sound/voice/scream_f3.ogg',
	)
...
/datum/scream_type/robotic
	name = "Robotic Scream"
	scream_sounds = list('modular_babylon/modules/emotes/sound/voice/scream_silicon.ogg')
...
/datum/scream_type/lizard2
	...
	scream_sounds = list('modular_babylon/modules/emotes/sound/voice/scream_lizard.ogg')

/datum/scream_type/cat
	name = "Cat Scream"
	scream_sounds = list('modular_babylon/modules/emotes/sound/voice/scream_cat.ogg')
...
/datum/scream_type/jelly
	name = "Jelly Scream"
	scream_sounds = list('modular_babylon/modules/emotes/sound/emotes/jelly_scream.ogg')

/datum/scream_type/vox
	name = "Vox Scream"
	scream_sounds = list('modular_babylon/modules/emotes/sound/emotes/voxscream.ogg')
...
/datum/scream_type/raptor //This is the Teshari scream ported from CitRP which was a cockatoo scream edited by BlackMajor.
	name = "Raptor Scream"
	scream_sounds = list('modular_babylon/modules/emotes/sound/emotes/raptorscream.ogg')

/datum/scream_type/rodent //Ported from Polaris/Virgo.
	name = "Rodent Scream"
	scream_sounds = list('modular_babylon/modules/emotes/sound/emotes/rodentscream.ogg')
...
/datum/scream_type/slugcat
	name = "Slugcat Scream"
	scream_sounds = list('modular_babylon/modules/emotes/sound/voice/scugscream_1.ogg')

//DONATOR SCREAMS
/datum/scream_type/zombie
	name = "Zombie Scream"
	scream_sounds = list('modular_babylon/modules/emotes/sound/emotes/zombie_scream.ogg')

/datum/scream_type/monkey
	name = "Monkey Scream"
	scream_sounds = list(
		'modular_babylon/modules/emotes/sound/voice/scream_monkey.ogg',
...
/datum/scream_type/skeleton
	...
	scream_sounds = list('modular_babylon/modules/emotes/sound/voice/scream_skeleton.ogg')
