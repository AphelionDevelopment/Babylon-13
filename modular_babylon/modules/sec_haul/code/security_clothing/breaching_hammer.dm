/obj/item/melee/breaching_hammer
	...
	icon = 'modular_babylon/modules/sec_haul/icons/peacekeeper/peacekeeper_items.dmi'
	icon_state = "peacekeeper_hammer"
	inhand_icon_state = "peacekeeper_hammer"
	worn_icon_state = "classic_baton"
	lefthand_file = 'modular_babylon/modules/sec_haul/icons/peacekeeper/baton/peacekeeper_baton_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/sec_haul/icons/peacekeeper/baton/peacekeeper_baton_righthand.dmi'
