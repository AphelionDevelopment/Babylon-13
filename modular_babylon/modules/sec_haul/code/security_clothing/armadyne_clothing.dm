/obj/item/clothing/under/rank/security/armadyne
	...
	icon = 'modular_babylon/master_files/icons/obj/clothing/under/centcom.dmi'	//This can probably be moved to centcom.dm when the suits are sorted
	worn_icon = 'modular_babylon/master_files/icons/mob/clothing/under/centcom.dmi'
	worn_icon_digi = 'modular_babylon/master_files/icons/mob/clothing/under/centcom_digi.dmi'
