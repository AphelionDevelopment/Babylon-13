...
/datum/atom_skin/security_belt/black
	...
	new_icon = 'modular_babylon/master_files/icons/obj/clothing/belts.dmi'
	new_icon_state = "belt_black"
	new_worn_icon = 'modular_babylon/master_files/icons/mob/clothing/belt.dmi'
...
/datum/storage/holster
	...
	// following "one gun per storage" is taken from secbelts, see modular_babylon\master_files\code\game\objects\items\storage\belt.dm
	...
	rustle_sound = 'modular_babylon/modules/sec_haul/sound/holsterin.ogg'
	remove_rustle_sound = 'modular_babylon/modules/sec_haul/sound/holsterout.ogg'
...
/datum/storage/holster/handle_exit(datum/source, obj/item/gone)
	...
	if(is_type_in_list(gone, limited_hold_types))
		playsound(parent, 'modular_babylon/modules/sec_haul/sound/holsterout.ogg', 50, rustle_vary, -5)
...
/datum/atom_skin/security_hudglasses
	...
	new_icon = 'modular_babylon/master_files/icons/obj/clothing/glasses.dmi'
	new_worn_icon = 'modular_babylon/master_files/icons/mob/clothing/eyes.dmi'
...
/obj/item/clothing/glasses/hud/security/sunglasses/blue
	icon = 'modular_babylon/master_files/icons/obj/clothing/glasses.dmi'
	worn_icon = 'modular_babylon/master_files/icons/mob/clothing/eyes.dmi'
...
/datum/atom_skin/hos_cap/blue
	...
	new_icon = 'modular_babylon/master_files/icons/obj/clothing/hats.dmi'
	new_icon_state = "hoscap_blue"
	new_worn_icon = 'modular_babylon/master_files/icons/mob/clothing/head.dmi'
...
/datum/atom_skin/tackler_gloves/blue
	preview_name = "Blue Variant"
	new_icon = 'modular_babylon/master_files/icons/obj/clothing/gloves.dmi'
	new_icon_state = "tackle_blue"
	new_worn_icon = 'modular_babylon/master_files/icons/mob/clothing/hands.dmi'
...
/obj/item/clothing/under/rank/security // Digitigrade sprites for sec
	worn_icon_digi = 'modular_babylon/master_files/icons/mob/clothing/under/security_digi.dmi'
...
/datum/atom_skin/hos_coat/trenchcloak
	...
	new_icon = 'modular_babylon/master_files/icons/obj/clothing/suits/armor.dmi'
	new_icon_state = "trenchcloak"
	new_worn_icon = 'modular_babylon/master_files/icons/mob/clothing/suits/armor.dmi'
...
/obj/item/clothing/shoes/jackboots/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/squeak, list('modular_babylon/master_files/sound/effects/footstep1.ogg'=1,'modular_babylon/master_files/sound/effects/footstep2.ogg'=1, 'modular_babylon/master_files/sound/effects/footstep3.ogg'=1), 100)
