...
/obj/item/organ/cyberimp/brain/nif
	...
	var/good_sound ='modular_babylon/modules/modular_implants/sounds/default_good.ogg'
	///This is the sound that plays if there is an issue going on.
	var/bad_sound = 'modular_babylon/modules/modular_implants/sounds/default_bad.ogg'
	///This is the sound that you would hear if you enable if you activate or enable something.
	var/click_sound = 'modular_babylon/modules/modular_implants/sounds/default_click.ogg'
	///What icon does the NIF display in chat when sending out alerts? Icon states are stored in 'modular_babylon/modules/modular_implants/icons/chat.dmi'
...
/datum/asset/spritesheet_batched/chat/create_spritesheets()
	...
	insert_all_icons("nif", 'modular_babylon/modules/modular_implants/icons/chat.dmi')
