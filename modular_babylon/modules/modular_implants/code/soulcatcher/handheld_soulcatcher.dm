...
/obj/item/handheld_soulcatcher
	...
	icon = 'modular_babylon/modules/modular_implants/icons/obj/devices.dmi'
...
/obj/item/handheld_soulcatcher/attack(mob/living/target_mob, mob/living/user, params)
	...
	playsound(src, 'modular_babylon/modules/modular_implants/sounds/default_good.ogg', 50, FALSE, ignore_walls = FALSE)
