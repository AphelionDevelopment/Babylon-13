...
/datum/component/soulcatcher/proc/scan_body(mob/living/parent_body, mob/living/user)
	...
	if(istype(parent, /obj/item/handheld_soulcatcher))
		...
		playsound(parent_device, 'modular_babylon/modules/modular_implants/sounds/default_good.ogg', 50, FALSE, ignore_walls = FALSE)
...
/atom/movable/screen/ghost/join_soulcatcher
	...
	icon = 'modular_babylon/master_files/icons/hud/screen_ghost.dmi'
