...
/obj/item/gun/energy/alien/zeta
	...
	icon = 'modular_babylon/modules/awaymissions_nova/icons/alienblaster.dmi'
	lefthand_file = 'modular_babylon/modules/awaymissions_nova/icons/alienhand.dmi'
	righthand_file = 'modular_babylon/modules/awaymissions_nova/icons/alienhand2.dmi'
