...
/obj/item/reagent_containers/hypospray/medipen/deforest/printable
	...
	icon = 'modular_babylon/modules/chemistry_love/icons/obj/medical/pen_medipens/pen_medipens.dmi'
	icon_state = "default"
	base_icon_state = "default"
	volume = 25
	fill_icon = 'modular_babylon/modules/chemistry_love/icons/obj/medical/pen_medipens/fill_overlay.dmi'
