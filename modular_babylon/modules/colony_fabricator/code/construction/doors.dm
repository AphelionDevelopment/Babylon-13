...
/obj/machinery/door/poddoor/shutters/colony_fabricator
	...
	icon = 'modular_babylon/modules/colony_fabricator/icons/doors/shutter.dmi'
...
/obj/machinery/door/airlock/colony_prefab
	name = "prefab airlock"
	icon = 'modular_babylon/modules/colony_fabricator/icons/doors/airlock.dmi'
	overlays_file = 'modular_babylon/modules/colony_fabricator/icons/doors/overlays.dmi'
