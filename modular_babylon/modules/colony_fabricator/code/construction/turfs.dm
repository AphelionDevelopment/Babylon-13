...
/turf/closed/wall/prefab_plastic
	...
	icon = 'modular_babylon/modules/colony_fabricator/icons/prefab_wall.dmi'
	icon_state = "prefab-0"
...
/obj/item/stack/sheet/plastic_wall_panel
	...
	desc = "What better material to make the walls of your soon to be home out of than sheets of flimsy plastic? \
		...
		than walls."
	icon = 'modular_babylon/modules/colony_fabricator/icons/tiles_item.dmi'
...
/turf/open/floor/catwalk_floor/colony_fabricator
	icon = 'modular_babylon/modules/colony_fabricator/icons/tiles.dmi'
