/obj/structure/mineral_door/manual_colony_door
	name = "manual airlock"
	icon = 'modular_babylon/modules/colony_fabricator/icons/doors/airlock_manual.dmi'
	material_flags = NONE
	icon_state = "manual"
	openSound = 'modular_babylon/modules/colony_fabricator/sound/manual_door/manual_door_open.wav'
	closeSound = 'modular_babylon/modules/colony_fabricator/sound/manual_door/manual_door_close.wav'
...
/obj/item/flatpacked_machine/airlock_kit_manual
	...
	icon = 'modular_babylon/modules/colony_fabricator/icons/doors/packed.dmi'
