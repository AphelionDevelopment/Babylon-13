...
/obj/machinery/power/stirling_generator
	...
	icon = 'modular_babylon/modules/colony_fabricator/icons/stirling_generator/big_generator.dmi'
	icon_state = "stirling"
	density = TRUE
...
/obj/item/flatpacked_machine/stirling_generator
	...
	icon = 'modular_babylon/modules/colony_fabricator/icons/stirling_generator/packed_machines.dmi'
	icon_state = "stirling"
