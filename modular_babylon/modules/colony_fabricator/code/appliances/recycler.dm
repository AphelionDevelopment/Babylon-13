/obj/machinery/colony_recycler
	...
	desc = "A large crushing machine used to recycle small items inefficiently. Items are inserted by hand, rather than by belt. \
		Mind your fingers."
	icon = 'modular_babylon/modules/colony_fabricator/icons/portable_machines.dmi'
	icon_state = "recycler"
	anchored = FALSE
	density = TRUE
	circuit = null
	...
	var/item_recycle_sound = 'modular_babylon/modules/reagent_forging/sound/forge.ogg'
...
/obj/item/flatpacked_machine/recycler
	...
	icon = 'modular_babylon/modules/colony_fabricator/icons/parts_kits.dmi'
	icon_state = "recycler"
