/mob/living/basic/pet/dog/shorg // I had thought of a different names such as shitten(shark+kitten), but shorg sounds fine
	...
	icon = 'modular_babylon/modules/shorg/icons/pets.dmi'
	held_lh = 'modular_babylon/modules/shorg/icons/pets_held_lh.dmi'
	held_rh = 'modular_babylon/modules/shorg/icons/pets_held_rh.dmi'
	icon_state = "shorg"
	icon_living = "shorg"
