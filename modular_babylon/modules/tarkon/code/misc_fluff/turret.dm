/obj/item/storage/toolbox/emergency/turret/mag_fed/cerberus
	...
	icon = 'modular_babylon/modules/tarkon/icons/obj/turret.dmi'
	icon_state = "cerberus_toolbox"
	righthand_file = 'modular_babylon/modules/tarkon/icons/mob/inhands/righthand.dmi'
	...
	worn_icon = 'modular_babylon/modules/tarkon/icons/mob/clothing/belt.dmi'
	has_latches = FALSE
