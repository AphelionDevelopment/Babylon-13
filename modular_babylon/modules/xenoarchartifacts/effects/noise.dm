/datum/artifact_effect/noise
	...
	var/static/list/possible_noises = list(
		...
		'modular_babylon/modules/random_ship_event/random_ships/heliostatic_inspectors/sounds/alarm_radio.ogg',
		'modular_babylon/modules/random_ship_event/random_ships/heliostatic_inspectors/sounds/morse.ogg', // I can spend all day here, adding sounds. But i wont.
	)
