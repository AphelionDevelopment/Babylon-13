/obj/item/xenoarch/wave_scanner_backpack
	...
	icon = 'modular_babylon/modules/xenoarchartifacts/icons/tools.dmi'
	worn_icon = 'modular_babylon/modules/xenoarchartifacts/icons/worn.dmi'
...
/obj/item/xenoarch/wave_scanner_backpack/verb/toggle_searcher()
	...
	if(processor.loc == src)
		...
		if(!user.put_in_hands(processor))
			...
			return
		playsound(src, 'modular_babylon/modules/aesthetics/lightswitch/sound/lightswitch.ogg', 50, FALSE)
	else
