/obj/item/xenoarch/particles_battery
	...
	icon = 'modular_babylon/modules/xenoarchartifacts/icons/machinery.dmi'
	...
	if(istype(attacking_item, /obj/item/xenoarch/particles_battery))
		if(!inserted_battery)
			if(user.transferItemToLoc(attacking_item, src))
				...
				playsound(src, 'modular_babylon/modules/aesthetics/lightswitch/sound/lightswitch.ogg', 25, FALSE)
