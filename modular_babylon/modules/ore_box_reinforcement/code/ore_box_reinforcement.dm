...
/obj/item/ore_box_reinforcement
	...
	icon = 'modular_babylon/modules/mining_crushers/icons/crusher_conversion_kit.dmi'
	icon_state = "crusher_kit"
	lefthand_file = 'modular_babylon/modules/mining_crushers/icons/kit_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/mining_crushers/icons/kit_righthand.dmi'
...
/obj/structure/ore_box/reinforced
	icon = 'modular_babylon/modules/ore_box_reinforcement/icons/ore_box.dmi'
