...
/turf/closed/mineral/strange_rock
	...
	icon = MAP_SWITCH('modular_babylon/master_files/icons/turf/smoothrocks.dmi', 'modular_babylon/modules/xenoarch/icons/mining.dmi')
	scan_icon = 'modular_babylon/modules/xenoarch/icons/ore_visuals.dmi'
...
/turf/closed/mineral/strange_rock/ice
	...
	icon = MAP_SWITCH('icons/turf/walls/icerock_wall.dmi', 'modular_babylon/modules/xenoarch/icons/mining.dmi')
...
/turf/closed/mineral/gibtonite/asteroid
	...
	icon = MAP_SWITCH('icons/turf/walls/red_rock.dmi', 'modular_babylon/modules/xenoarch/icons/mining.dmi')
