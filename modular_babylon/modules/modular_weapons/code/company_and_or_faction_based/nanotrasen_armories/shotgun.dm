/obj/item/gun/ballistic/shotgun/katyusha
	...
	icon = 'modular_babylon/modules/modular_weapons/icons/obj/company_and_or_faction_based/nanotrasen_armories/ballistic48x.dmi'
	icon_state = "spikewall"

	worn_icon = 'modular_babylon/modules/modular_weapons/icons/mob/company_and_or_faction_based/nanotrasen_armories/guns_worn.dmi'
	worn_icon_state = "spikewall"

	lefthand_file = 'modular_babylon/modules/modular_weapons/icons/mob/company_and_or_faction_based/nanotrasen_armories/guns_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/modular_weapons/icons/mob/company_and_or_faction_based/nanotrasen_armories/guns_righthand.dmi'
	...
	fire_sound = 'modular_babylon/master_files/sound/weapons/shotgun_nova.ogg' // Meatier shotgun sound
