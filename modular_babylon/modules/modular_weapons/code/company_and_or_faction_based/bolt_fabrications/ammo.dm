/obj/projectile/bullet/kineticball
	name = "kinetic orb"
	icon = 'modular_babylon/modules/modular_weapons/icons/obj/company_and_or_faction_based/bolt_fabrications/riotrubberbullet.dmi'
...
/obj/item/ammo_casing/kineticball
	...
	icon = 'modular_babylon/modules/modular_weapons/icons/obj/company_and_or_faction_based/bolt_fabrications/stingtop.dmi'
