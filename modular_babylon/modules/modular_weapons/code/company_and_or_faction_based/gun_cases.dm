...
/obj/item/storage/toolbox/guncase/nova
	...
	icon = 'modular_babylon/modules/modular_weapons/icons/obj/gunsets.dmi'
	icon_state = "guncase"
	worn_icon = 'modular_babylon/modules/modular_weapons/icons/mob/worn/cases.dmi'
	worn_icon_state = "darkcase"
	lefthand_file = 'modular_babylon/modules/modular_weapons/icons/mob/inhands/cases_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/modular_weapons/icons/mob/inhands/cases_righthand.dmi'
