/obj/item/gun/ballistic/automatic/pistol/enforcer
	...
	icon = 'modular_babylon/modules/modular_weapons/icons/obj/company_and_or_faction_based/scarborough_arms/pistol.dmi'
	icon_state = "magnum"
	lefthand_file = 'modular_babylon/modules/modular_weapons/icons/mob/company_and_or_faction_based/scarborough_arms/guns_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/modular_weapons/icons/mob/company_and_or_faction_based/scarborough_arms/guns_righthand.dmi'
	...
	fire_sound = 'modular_babylon/modules/modular_weapons/sounds/bay_gunshot_magnum.ogg'
	load_sound = 'modular_babylon/modules/modular_weapons/sounds/bay_magnum_in.ogg'
	load_empty_sound = 'modular_babylon/modules/modular_weapons/sounds/bay_magnum_in.ogg'
	eject_sound = 'modular_babylon/modules/modular_weapons/sounds/bay_magnum_out.ogg'
	eject_empty_sound = 'modular_babylon/modules/modular_weapons/sounds/bay_magnum_out.ogg'
