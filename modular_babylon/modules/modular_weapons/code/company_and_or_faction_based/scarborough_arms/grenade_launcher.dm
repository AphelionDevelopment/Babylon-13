...
/obj/item/gun/ballistic/pump_launcher
	...
	icon = 'modular_babylon/modules/modular_weapons/icons/obj/company_and_or_faction_based/scarborough_arms/launchers48x.dmi'
	icon_state = "boarder40"
	worn_icon = 'modular_babylon/modules/modular_weapons/icons/mob/company_and_or_faction_based/scarborough_arms/guns_worn.dmi'
