...
/obj/item/gun/ballistic/automatic/sol_classic
	...
	icon = 'modular_babylon/modules/modular_weapons/icons/obj/company_and_or_faction_based/veldjen-kuiper_armories/guns48x.dmi'
	icon_state = "infanterie"

	worn_icon = 'modular_babylon/modules/modular_weapons/icons/mob/company_and_or_faction_based/veldjen-kuiper_armories/guns_worn.dmi'
	worn_icon_state = "infanterie"

	lefthand_file = 'modular_babylon/modules/modular_weapons/icons/mob/company_and_or_faction_based/veldjen-kuiper_armories/guns_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/modular_weapons/icons/mob/company_and_or_faction_based/veldjen-kuiper_armories/guns_righthand.dmi'
	...
	fire_sound = 'modular_babylon/modules/modular_weapons/sounds/rifle_heavy.ogg'
	suppressed_sound = 'modular_babylon/modules/modular_weapons/sounds/suppressed_rifle.ogg'
	can_suppress = TRUE
