/obj/item/gun/ballistic/automatic/pulse_rifle
	...
	semi_auto = FALSE
	can_suppress = FALSE
	fire_sound = 'modular_babylon/modules/modular_weapons/sounds/pulse_shoot.ogg'
	fire_sound_volume = 50
	lock_back_sound = 'modular_babylon/modules/modular_weapons/sounds/pulse_pull.ogg'
	bolt_drop_sound = 'modular_babylon/modules/modular_weapons/sounds/pulse_push.ogg'
