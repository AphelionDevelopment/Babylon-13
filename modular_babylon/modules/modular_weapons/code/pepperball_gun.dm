/obj/item/gun/ballistic/automatic/pistol/pepperball
	...
	icon = 'modular_babylon/modules/modular_weapons/icons/obj/pepperball/pepperball.dmi'
...
/obj/projectile/bullet/pepperball
	name = "pepperball orb"
	icon = 'modular_babylon/modules/modular_weapons/icons/obj/pepperball/projectiles.dmi'
	icon_state = "pepperball"
	damage = 0
	stamina = 5
	shrapnel_type = null
...
/obj/item/ammo_box/advanced/pepperballs
	name = "pepperball ammo box"
	icon = 'modular_babylon/modules/modular_weapons/icons/obj/pepperball/ammoboxes.dmi'
	icon_state = "box10x24"
