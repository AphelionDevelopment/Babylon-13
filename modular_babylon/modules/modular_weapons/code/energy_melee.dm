...
/obj/item/melee/energy/sword/saber/covenant
	...
	icon = 'modular_babylon/modules/modular_weapons/icons/obj/melee.dmi'
	icon_state = "covenant"
	inhand_icon_state = "covenant"
	base_icon_state = "covenant"
	lefthand_file = 'modular_babylon/modules/modular_weapons/icons/mob/inhands/64x_melee_left.dmi'
	righthand_file = 'modular_babylon/modules/modular_weapons/icons/mob/inhands/64x_melee_right.dmi'
...
/obj/item/melee/energy/sword/saber/covenant/multitool_act(mob/living/user, obj/item/tool)
	var/list/color_menu = list(
		"Blue" = image(icon = 'modular_babylon/modules/modular_weapons/icons/obj/melee.dmi', icon_state = "covenant_on_blue"),
		"Green" = image(icon = 'modular_babylon/modules/modular_weapons/icons/obj/melee.dmi', icon_state = "covenant_on_green"),
		"Red" = image(icon = 'modular_babylon/modules/modular_weapons/icons/obj/melee.dmi', icon_state = "covenant_on_red"),
		"Purple" = image(icon = 'modular_babylon/modules/modular_weapons/icons/obj/melee.dmi', icon_state = "covenant_on_purple"),
	)
