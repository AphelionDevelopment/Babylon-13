...
/obj/machinery/mounted_machine_gun
	...
	icon = 'modular_babylon/modules/mounted_machine_gun/icons/turret.dmi'
	icon_state = "mmg"
	base_icon_state = "mmg"
	can_buckle = TRUE
	anchored = FALSE
	...
	var/firesound = 'modular_babylon/modules/mounted_machine_gun/sound/50cal_box_01.ogg'
...
/obj/machinery/mounted_machine_gun/item_interaction(mob/living/user, obj/item/tool, list/modifiers)
	...
	ammo_box = tool
	tool.forceMove(src)
	playsound(src, 'modular_babylon/modules/mounted_machine_gun/sound/insert_ammobox.ogg', 100)
...
/obj/machinery/mounted_machine_gun/proc/remove_ammo_box(mob/living/user)
	...
	ammo_box = null
	playsound(src, 'modular_babylon/modules/mounted_machine_gun/sound/remove_ammobox.ogg', 100)
...
/obj/machinery/mounted_machine_gun/proc/toggle_cover(mob/user)
	...
	playsound(src, cover_open ? 'modular_babylon/modules/mounted_machine_gun/sound/open_lid.ogg' : 'modular_babylon/modules/mounted_machine_gun/sound/close_lid.ogg', 100)
...
/obj/machinery/mounted_machine_gun/proc/cock_bolt()
	if(bolt)
		return
	bolt = TRUE
	playsound(src, 'modular_babylon/modules/mounted_machine_gun/sound/cock_bolt.ogg', 100)
...
/obj/item/mounted_machine_gun_folded
	...
	icon = 'modular_babylon/modules/mounted_machine_gun/icons/turret_objects.dmi'
