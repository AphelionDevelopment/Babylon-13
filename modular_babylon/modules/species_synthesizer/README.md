...
- Added to `modular_babylon/modules/synths/code/species/synthetic.dm`:
...
- Added to `modular_babylon/master_files/code/modules/mob/living/carbon/human/species_type/ethereal.dm`:
