...
/obj/item/shockpaddles/syndicate/cyborg/ninja
	...
	icon = 'modular_babylon/modules/borgs/icons/robot_items.dmi'
...
/obj/item/borg_shapeshifter
	...
	/// Traits unique to this model (deadsprite, wide/quadborginess, etc.). Mirrors the definition in modular_babylon\modules\borgs\code\modules\mob\living\silicon\robot\robot_model.dm
