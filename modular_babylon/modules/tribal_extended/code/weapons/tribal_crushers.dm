...
/obj/item/kinetic_crusher/runic_greatsword
	...
	icon = 'modular_babylon/modules/tribal_extended/icons/tribal_crushers.dmi'
	icon_state = "runic_greatsword"
	worn_icon = 'modular_babylon/modules/tribal_extended/icons/back.dmi'
	worn_icon_state = "runic_greatsword"
	lefthand_file = 'modular_babylon/modules/tribal_extended/icons/swords_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/tribal_extended/icons/swords_righthand.dmi'
...
/obj/item/kinetic_crusher/runic_greataxe
	...
	icon = 'modular_babylon/modules/tribal_extended/icons/tribal_crushers.dmi' //Modified sprite from Roguetown
...
/obj/item/kinetic_crusher/spear/runic_spear
	...
	icon = 'modular_babylon/modules/tribal_extended/icons/tribal_crushers.dmi' //Custom sprite, i'm a bad spriter, mhkay?
...
/obj/item/kinetic_crusher/proc/add_runic_glow()
	return emissive_appearance(
		'modular_babylon/modules/tribal_extended/icons/tribal_crushers.dmi',
		"[icon_state]-emissive",
		src,
		alpha = src.alpha
	)
...
/datum/asset/spritesheet_batched/crafting/create_spritesheets()
	. = ..()
	insert_icon(replacetext(TOOL_HAMMER, " ", ""), uni_icon('modular_babylon/modules/reagent_forging/icons/obj/forge_items.dmi', "hammer"))
