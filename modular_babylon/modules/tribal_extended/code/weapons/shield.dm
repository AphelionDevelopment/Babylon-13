/obj/item/shield/goliath
	...
	icon = 'modular_babylon/modules/tribal_extended/icons/shields.dmi'
	icon_state = "goliath_shield"
	lefthand_file = 'modular_babylon/modules/tribal_extended/icons/shields_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/tribal_extended/icons/shields_righthand.dmi'
