/obj/machinery/ammo_workbench
	...
	icon = 'modular_babylon/modules/ammo_workbench/icons/ammo_workbench.dmi'
	...
	/// bitflags for allowed ammo types (see modular_babylon/modules/ammo_workbench/code/ammo_bench_defines.dm)
