/obj/item/bong
	...
	icon = 'modular_babylon/modules/bongs/icons/bong.dmi'
	lefthand_file = 'modular_babylon/modules/bongs/icons/lefthand.dmi'
	righthand_file = 'modular_babylon/modules/bongs/icons/righthand.dmi'
	icon_state = "bongoff"
...
/obj/item/bong/attack(mob/hit_mob, mob/user, def_zone)
	...
	if(moan_chance > 0)
		if(prob(moan_chance))
			playsound(hit_mob, pick('modular_babylon/master_files/sound/effects/lungbust_moan1.ogg','modular_babylon/master_files/sound/effects/lungbust_moan2.ogg', 'modular_babylon/master_files/sound/effects/lungbust_moan3.ogg'), 50, TRUE)
			hit_mob.emote("moan")
		else
			playsound(hit_mob, pick('modular_babylon/master_files/sound/effects/lungbust_cough1.ogg','modular_babylon/master_files/sound/effects/lungbust_cough2.ogg'), 50, TRUE)
			hit_mob.emote("cough")
	if(bong_hits <= 0)
