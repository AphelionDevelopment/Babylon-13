...
/obj/item/circular_saw/field_medic
	...
	force = 20
	icon_state = "bonesaw"
	icon = 'modular_babylon/modules/exp_corps/icons/bonesaw.dmi'
	lefthand_file = 'modular_babylon/modules/exp_corps/icons/bonesaw_l.dmi'
	righthand_file = 'modular_babylon/modules/exp_corps/icons/bonesaw_r.dmi'
...
/obj/item/shield/riot/pointman
	...
	icon_state = "riot"
	icon = 'modular_babylon/modules/exp_corps/icons/riot.dmi'
	worn_icon = 'modular_babylon/master_files/icons/mob/clothing/back.dmi'
	worn_icon_state = "erisriot"
	lefthand_file = 'modular_babylon/modules/exp_corps/icons/riot_left.dmi'
	righthand_file = 'modular_babylon/modules/exp_corps/icons/riot_right.dmi'
	force = 10
	throwforce = 5
	throw_speed = 1
	throw_range = 1
...
/obj/item/knife/combat/throwing
	...
	icon = 'modular_babylon/modules/exp_corps/icons/throwing.dmi'
	icon_state = "throwing"
