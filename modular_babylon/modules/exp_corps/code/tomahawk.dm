/obj/item/melee/tomahawk
	...
	icon = 'modular_babylon/modules/exp_corps/icons/tomahawk.dmi'
	icon_state = "tomahawk"
	inhand_icon_state = "tomahawk"
	lefthand_file = 'modular_babylon/modules/exp_corps/icons/tomahawk_l.dmi'
	righthand_file = 'modular_babylon/modules/exp_corps/icons/tomahawk_r.dmi'
	worn_icon = 'modular_babylon/modules/exp_corps/icons/tomahawk_worn.dmi'
