...
/obj/machinery/power/colony_ore_thumper
	...
	icon = 'modular_babylon/modules/kahraman_equipment/icons/ore_thumper.dmi'
	...
	var/static/list/list_of_thumper_sounds = list(
		'modular_babylon/modules/kahraman_equipment/sound/thumper_thump/punch_press_1.wav',
		'modular_babylon/modules/kahraman_equipment/sound/thumper_thump/punch_press_2.wav',
	)
...
/obj/machinery/power/colony_ore_thumper/proc/make_some_ore()
	...
	for(var/iteration in 1 to rand(2, 4))
		...
		playsound(new_ore_pile, 'modular_babylon/master_files/sound/effects/robot_sit.ogg', 25, TRUE)
...
/obj/item/flatpacked_machine/ore_thumper
	...
	icon = 'modular_babylon/modules/kahraman_equipment/icons/ore_thumper_item.dmi'
