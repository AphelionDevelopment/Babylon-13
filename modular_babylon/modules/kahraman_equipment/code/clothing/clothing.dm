...
/obj/item/clothing/under/frontier_colonist
	...
	icon = 'modular_babylon/modules/kahraman_equipment/icons/clothes/clothing.dmi'
	icon_state = "jumpsuit"
	worn_icon = 'modular_babylon/modules/kahraman_equipment/icons/clothes/clothing_worn.dmi'
	worn_icon_digi = 'modular_babylon/modules/kahraman_equipment/icons/clothes/clothing_worn_digi.dmi'
	worn_icon_teshari = 'modular_babylon/modules/kahraman_equipment/icons/clothes/clothing_worn_teshari.dmi'
...
/obj/item/radio/headset/headset_frontier_colonist
	...
	radio_talk_sound = 'modular_babylon/modules/kahraman_equipment/sound/morse_signal.wav'
