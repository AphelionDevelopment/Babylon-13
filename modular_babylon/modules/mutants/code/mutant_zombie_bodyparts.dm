...
/obj/item/bodypart/head/mutant_zombie
	icon_greyscale = 'modular_babylon/modules/mutants/icons/mutant_parts_greyscale.dmi'
	icon = 'modular_babylon/modules/mutants/icons/mutant_parts_greyscale.dmi'
	icon_static = 'modular_babylon/modules/mutants/icons/mutant_parts_greyscale.dmi'
	icon_state = "mutant_head"
	is_dimorphic = FALSE
	limb_id = SPECIES_MUTANT
	species_color = "#ffffff"
	head_flags = HEAD_HAIR|HEAD_LIPS|HEAD_DEBRAIN
	eyes_icon = 'modular_babylon/modules/mutants/icons/mutant_eyes.dmi'
