...
/obj/item/hnz_mutant_hand
	...
	lefthand_file = 'modular_babylon/modules/mutants/icons/mutant_hand_lefthand.dmi'
	righthand_file = 'modular_babylon/modules/mutants/icons/mutant_hand_righthand.dmi'
