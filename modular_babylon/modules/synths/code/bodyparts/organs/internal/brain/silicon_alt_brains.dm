...
/obj/item/mmi/posibrain/circuit
	...
	icon = 'modular_babylon/master_files/icons/obj/alt_silicon_brains.dmi'
	icon_state = "circuit"
...
// See modular_babylon/master_files/code/modules/client/preferences/brain.dm for Synth/IPC application.
