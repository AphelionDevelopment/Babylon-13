#define SHAPESHIFTER_ACTIONS_ICON_FILE 'modular_babylon/modules/shapeshifter_quirk/icons/actions_shapeshift.dmi'

/datum/action/innate/alter_form/quirk
	name = "Shapeshift"
	slime_restricted =  FALSE
	button_icon = 'modular_babylon/master_files/icons/mob/actions/actions_slime.dmi'
