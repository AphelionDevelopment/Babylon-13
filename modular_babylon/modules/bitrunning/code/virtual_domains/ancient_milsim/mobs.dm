...
/datum/ai_controller/basic_controller/trooper/calls_reinforcements/ancient_milsim
	behavior_tree_json = "modular_babylon/modules/bitrunning/code/virtual_domains/ancient_milsim/cin_soldier.bt.json"
	blackboard = list(
...
/datum/ai_controller/basic_controller/trooper/calls_reinforcements/ancient_milsim/ranged
	behavior_tree_json = "modular_babylon/modules/bitrunning/code/virtual_domains/ancient_milsim/cin_soldier_ranged.bt.json"
...
/mob/living/basic/trooper/cin_soldier/ranged
	...
	var/projectilesound = 'modular_babylon/modules/modular_weapons/sounds/smg_light.ogg'
...
/mob/living/basic/trooper/cin_soldier/ranged/shotgun_revolver
	...
	projectilesound = 'modular_babylon/modules/sec_haul/sound/revolver_fire.ogg'
	burst_shots = 1
