...
/obj/item/pipe_dispenser/bluespace
	...
	icon = 'modular_babylon/modules/bsrpd/icons/bsrpd.dmi'
	icon_state = "bsrpd"
	lefthand_file = 'modular_babylon/modules/bsrpd/icons/bsrpd_left.dmi'
	righthand_file = 'modular_babylon/modules/bsrpd/icons/bsrpd_right.dmi'
