...
/obj/item/airbag
	...
	icon = 'modular_babylon/modules/inflatables/icons/inflatable.dmi'
	...
	var/armed_sound = 'modular_babylon/modules/window_airbags/sound/airbag_arm.ogg'
	/// The sound we play when we go bang
	var/bang_sound = 'modular_babylon/modules/window_airbags/sound/airbag_bang.ogg'
