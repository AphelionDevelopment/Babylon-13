...
if not os.path.isfile(babylon_defines_file):
	print(red(f"Could not find the nova defines file '{babylon_defines_file}'!"))
	sys.exit(1)
...
# NOVA EDIT ADDITION START
scannable_lines = []
with open(babylon_defines_file, 'r') as file:
	reading = False
